...
-- RegisterNetEvent('bd-casino:setBalance')
-- AddEventHandler('bd-casino:setBalance', function() 
--     SendNUIMessage({action = 'setCurrentChips', amount = exports["bd-inventory"]:getQuantity("redchip") })
-- end)
...
--                         local keyboard = exports["bd-dialog"]:KeyboardInput({
--                             header = "Place Bet", 
...
--             Citizen.Wait(1500)
--         else
--             TriggerServerEvent('bd-roulette:notUsing', selectedRoulette)
...
--                                                     TriggerServerEvent('bd-roulette:taskBetRoulette', selectedRoulette, aimingAtBet, currentBetAmount)
--                                                 else
...
--     TriggerEvent('bd-casino:events:entered')
-- end)

-- AddEventHandler('bd-casino:events:entered', function()
...
-- RegisterNetEvent('bd-roulette:isSeatUsed')
-- AddEventHandler('bd-roulette:isSeatUsed', function(data, a1)
--     local k = data['k']
...
-- AddEventHandler('bd-casino:roulette:selectChair', function(data)
--     local entity = data.entity
--     if exports['bd-casino']:inCasino() then
...
--                             if exports['bd-inventory']:hasEnoughOfItem('casinovip', 1) then
--                                 TriggerServerEvent('bd-roulette:isSeatUsed', { k = k, closestChairData = closestChairData.chairId}, closestChairData)
--                             else
...
--         TriggerServerEvent('bd-roulette:taskStartRoulette', index, chairId)
--     end
-- end

-- RegisterNetEvent('bd-roulette:openRoulette')
-- AddEventHandler('bd-roulette:openRoulette',function(rouletteIndex)
...
-- RegisterNetEvent('bd-roulette:startSpin')
-- AddEventHandler(
--     'bd-roulette:startSpin',
...
-- RegisterNetEvent('bd-roulette:updateStatus')
-- AddEventHandler('bd-roulette:updateStatus', function(rouletteIndex, time, status)
...
-- RegisterNetEvent('bd-roulette:updateTableBets')
-- AddEventHandler('bd-roulette:updateTableBets', function(rouletteIndex, bets)
--     if Roulettes[rouletteIndex] ~= nil then
...
-- RegisterNetEvent('bd-roulette:updateChips')
-- AddEventHandler('bd-roulette:updateChips', function()
--     SendNUIMessage({action = 'setCurrentChips', amount = exports["bd-inventory"]:getQuantity("redchip")})
-- end)
...
-- RegisterNetEvent('bd-roulette:playBetAnim')
-- AddEventHandler('bd-roulette:playBetAnim', function(chairId)
--     local sex = 0
...
-- RegisterNetEvent('bd-roulette:playWinAnim')
-- AddEventHandler('bd-roulette:playWinAnim', function(chairId)
--     local rot = CURRENT_CHAIR_DATA.rotation
...
-- RegisterNetEvent('bd-roulette:playLossAnim')
-- AddEventHandler('bd-roulette:playLossAnim', function(chairId)
--     local rot = CURRENT_CHAIR_DATA.rotation
