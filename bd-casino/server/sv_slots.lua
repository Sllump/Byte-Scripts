...
RegisterNetEvent("bd-slotmachines-sv:sitDownAtSlotMachine",function(slot)
    activeSlots = slot
    print(slot)
    local coinValue = 1
    TriggerClientEvent("bd-slotmachines-cl:sitDownAtSlotMachine",source, slot)
end)

RegisterNetEvent("bd-slotmachines-sv:spinMachine",function(currentSlotMachinePos,currentSlotMachineModel,currentBet,cid)
    ...
    TriggerClientEvent('bd-slotmachines-cl:startSpin', source, w)
end)

RegisterNetEvent('bd-slotmachines-sv:slotsCheckWin')
AddEventHandler('bd-slotmachines-sv:slotsCheckWin',function(win, dt)
	CheckForWin(win, dt)
end)
...
function CheckForWin(w, data)
    ...
    TriggerClientEvent("bd-slotmachines-cl:spinFinished", source, total)
end


RegisterServerEvent('bd-casino:slotsLogWin')
AddEventHandler('bd-casino:slotsLogWin', function(pWinAmount)
