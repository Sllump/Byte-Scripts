...
--     local p = promise.new()
--     local player = exports["bd-base"]:getModule("Player"):GetUser(source)
--     if player then
--         TriggerClientEvent('bd-casino:setBalance', source)
--     end
...
--         TriggerEvent('bd-casino:blackjack:getBalance', player.source)
--     end
-- end
...
--         else
--             TriggerClientEvent('bd-roulette:isSeatUsed', src, data, a1)
--         end
--     else
--         TriggerClientEvent('bd-roulette:isSeatUsed', src, data, a1)
--     end
...
-- RegisterNetEvent('bd-roulette:taskStartRoulette')
-- AddEventHandler('bd-roulette:taskStartRoulette', function(rouletteIndex, chairId)
--         local source = source

--         local xPlayer = exports["bd-base"]:getModule("Player"):GetUser(source)
--         if xPlayer then
--             if activeRoulettes[rouletteIndex] == nil then
...
--                 TriggerClientEvent('bd-roulette:openRoulette', source, rouletteIndex)
--                 TriggerClientEvent('bd-roulette:updateChips', source)
--             else
...
-- RegisterNetEvent('bd-roulette:notUsing')
-- AddEventHandler('bd-roulette:notUsing',function(rouletteIndex)
--     local source = source
--     if activeRoulettes[rouletteIndex] ~= nil then
...
--                     TriggerClientEvent('bd-roulette:updateStatus', -1, rouletteIndex, v.time, v.status)
--                 end
...
--                         TriggerClientEvent('bd-roulette:startSpin', -1, rouletteIndex, randomSpinNumber)
--                         Citizen.Wait(15500)
...
--                             TriggerClientEvent('bd-roulette:updateTableBets', -1, rouletteIndex, activeRoulettes[rouletteIndex].bets)
--                         else
...
--                                 TriggerClientEvent('bd-roulette:updateStatus', -1, rouletteIndex, nil, nil)
--                             else
--                                 activeRoulettes[rouletteIndex].status = false
--                                 activeRoulettes[rouletteIndex].time = Config.RouletteStart
--                                 activeRoulettes[rouletteIndex].WinningBetIndex = nil
...
--         local xPlayer = exports["bd-base"]:getModule("Player"):GetUser(betData.playerSrc)
--         if xPlayer then
...
--         if chairId ~= nil then
--             TriggerClientEvent('bd-roulette:playWinAnim', targetSrc, chairId)
--         end
--     end
...
--         local chairId = getPlayerTableSeat(targetSrc)
--         if chairId ~= nil then
--             TriggerClientEvent('bd-roulette:playLossAnim', targetSrc, chairId)
--         end
--     end
-- end
...
-- RegisterNetEvent('bd-roulette:taskBetRoulette')
-- AddEventHandler('bd-roulette:taskBetRoulette', function(rouletteIndex, betId, betAmount)
--     local source = source
--     local xPlayer = exports["bd-base"]:getModule("Player"):GetUser(source)
--     if xPlayer then
--         if activeRoulettes[rouletteIndex] ~= nil then
...
--                     TriggerClientEvent('bd-roulette:playBetAnim', xPlayer.source, chairId)
--                 end
--             else
