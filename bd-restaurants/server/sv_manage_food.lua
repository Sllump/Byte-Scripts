RPC.register("bd-restaurants:getFoodItems", function(pSource, pBiz)
    return BUSINESSES[pBiz].foodItems
end)

RPC.register("bd-restaurants:fetchMenu", function(pSource, pBiz)
    return BUSINESSES[pBiz].menu
end)

RPC.register("bd-restaurants:createFoodItem", function(pSource, pData)
    ...
    TriggerClientEvent("bd-restaurants:changedFoodItems", -1, pRestaurant)
    return true
end)

RPC.register("bd-restaurants:deleteFoodItem", function(pSource, pItemId, pRestaurant)
...
RPC.register("bd-restaurants:setMenu", function(pSource, pBiz, pDishes)
    ...
    TriggerClientEvent("bd-restaurants:changedMenuItems", -1, pBiz)
    return true
end)
