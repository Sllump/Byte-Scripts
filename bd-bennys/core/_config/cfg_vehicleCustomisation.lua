...
local baseMaterialPrice = 25
local basePartPrice = (8 * baseMaterialPrice)

vehicleCustomisationPrices =
{
    cosmetics = 
    {
        price = basePartPrice * 2
    },
    respray = 
    {
        price = basePartPrice * 5
    },
    performance = 
    {
        prices = 
    ...
    turbo = 
    {
        price = basePartPrice * 68
    },
    wheels = 
    {
        price = basePartPrice * 4
    },
    customwheels = 
    {
        price = basePartPrice * 2
    ...
    windowtint = 
    {
        price = baseMaterialPrice * 2
    },
    neonside = 
    {
        price = baseMaterialPrice * 4
    },
    neoncolours = 
    {
        price = baseMaterialPrice * 2
