const _0x20e3bf = (function () {
    let _0x746025 = true
    return function (_0x59ecdd, _0x3b1fb2) {
      const _0xe9fc73 = _0x746025
        ? function () {
            if (_0x3b1fb2) {
              const _0x408b02 = _0x3b1fb2.apply(_0x59ecdd, arguments)
              return (_0x3b1fb2 = null), _0x408b02
            }
          }
        : function () {}
      return (_0x746025 = false), _0xe9fc73
    }
  })(),
  _0x5ec8d8 = _0x20e3bf(this, function () {
    return _0x5ec8d8
      .toString()
      .search('(((.+)+)+)+$')
      .toString()
      .constructor(_0x5ec8d8)
      .search(_0x203873.nKrwd)
  })
_0x5ec8d8()
;(() => {
  'use strict'
  var _0x370f39 = {
      ...
      558: (_0x26745d, _0x36236b, _0x491527) => {
        ...
        RPC.register(
          ...
          (_0x4d1383, _0x5ceeb5, _0x21199b) => {
            emitNet('arp:vehicles:addKey', Number(_0x21199b), _0x5ceeb5)
            emitNet(
              'DoLongHudText',
              Number(_0x21199b),
              'You just received keys to a vehicle!'
            )
          }
        )
        RPC.register(
          'arp:vehicles:sellPhone',
          async (_0x692882, _0x135d4d, _0x4b7fc2, _0x75dd77, _0x1e096b) => {
            emitNet(
        ...
        RPC.register(
          ...
          async (_0x196694, _0x16903a, _0x424495, _0x467ccb, _0x20b4f8) => {}
        )
        RPC.register(
          'arp:vehicles:getVehicles',
          async (_0x419926, _0x44805f) =>
            (await SQL.execute(
              'SELECT * FROM characters_cars WHERE garage = @garage',
              { garage: _0x44805f }
            )) || []
        )
        RPC.register(
          'arp:vehicles:basicSpawn',
          async (
            _0x26aac2,
            _0x214949,
            _0x3c0262,
        ...
        RPC.register(
          ...
          async (_0xd9dfad, _0xa9bc28, _0x3d3daf, _0x4a44b5) => {
            const _0x4394f2 = NetworkGetEntityFromNetworkId(_0xa9bc28)
            return !!(await (0, _0x13b062.CanRepairDegradation)(
              _0x4394f2,
              _0x3d3daf,
              _0x4a44b5
            ))
        ...
        RPC.register(
          ...
          (_0x4d0f37, _0x3f9799, _0x2d8a13, _0x386c94, _0x2c954a) => {
            if (_0x2c954a) {
              const _0x55d98f = NetworkGetEntityFromNetworkId(_0x3f9799)
              ;(0, _0x13b062.FixVehicleDegredation)(
                _0x55d98f,
                _0x2d8a13,
                _0x386c94
              )
        ...
        RPC.register(
          'arp:vehicles:addDegradation',
          async (_0x2933b0, _0xda185b, _0x585be2) => {
            const _0x42431c = NetworkGetEntityFromNetworkId(_0xda185b)
            return !!(await (0, _0x13b062.SetVehicleDegradation)(
              _0x42431c,
              _0x585be2
            ))
          }
        ...
        RPC.register(
          ...
          async (_0x4d4761, _0x9011bb, _0x363b0d, _0x543f40) => {
            const _0x6281ce = await (0, _0x50099c.SpawnPlayerVehicle)(
              _0x4d4761,
              _0x9011bb,
              [_0x543f40.x, _0x543f40.y, _0x543f40.z],
              Number(_0x543f40.h),
              true
            )
            if (_0x6281ce.success) {
              if (
                !(await SQL.execute(
                  'UPDATE characters_cars SET state = @state WHERE vin = @vin',
                  {
                    state: 'out',
                    vin: _0x9011bb,
                  }
              ...
              const _0x2dcdfe =
                _0x5e2697.Base.getModule('Player').GetUser(_0x4d4761)
              if (!_0x2dcdfe) {
                return
              }
              ...
              return !(
                _0x18e13c.vin &&
                !(await SQL.execute(
                  'INSERT INTO parking_logs (vin, cid, action, engine, body, fuel, timestamp, garage) VALUES (@vin, @cid, @action, @engine, @body, @fuel, @timestamp, @garage)',
                  {
                    vin: _0x9011bb,
        ...
        RPC.register(
          ...
          async (_0x370222, _0xacf134, _0x5db31f) => {
            const _0x254830 = await SQL.execute(
              'SELECT * FROM parking_logs WHERE vin = @vin AND garage = @garage ORDER BY id DESC',
              {
                vin: _0xacf134,
                garage: _0x5db31f,
              }
        ...
        RPC.register(
          ...
          async (_0x51c113, _0x3c9167) => {
            const _0x17e17c = _0x491527.g.source,
              _0x580c39 = NetworkGetEntityFromNetworkId(_0x51c113)
            if (
              await (0, _0x3e1d26.GenerateVehicleInformation)(
                _0x17e17c,
                _0x580c39,
                _0x3c9167
              )
        ...
        RPC.register(
          ...
          async (_0xc0f8a3, _0x4852cf, _0x52a9eb) => {
            const _0x5603e3 = NetworkGetEntityFromNetworkId(_0x4852cf)
            return !!(await (0, _0x241375.StoreVehicleInGarage)(
              _0xc0f8a3,
              _0x5603e3,
              _0x52a9eb
            ))
        ...
        RPC.register('arp:vehicles:getFuelPrice', (_0x3a0495, _0x566069) => ({
          taxLevel: 15,
          fuelPrice: 3,
        }))
        RPC.register(
          'arp:vehicles:addFuel',
          (
            _0x35de69,
            _0x40234e,
            _0x475373,
        ...
        RPC.register(
          ...
          async (_0x125c20, _0x26eb8d, _0x4e101f) =>
            await (0, _0xdfced7.SetVehicleFakeLicensePlate)(
              _0x125c20,
              _0x26eb8d,
              _0x4e101f
            )
        ...
        RPC.register(
          ...
          async (_0x37017e, _0x52f9f6) =>
            await (0, _0xdfced7.GetLicensePlate)(_0x52f9f6)
        )
        RPC.register(
          'arp-vehicles:chargeForNOSRefill',
          async (_0x8823e5, _0x4dc379) => {}
        )
        RPC.register(
          'arp-vehicles:chargeForFuelRefill',
          async (_0x2c61b8, _0x2a7e28) => {
            const _0x16d558 =
              _0x5e2697.Base.getModule('Player').GetUser(_0x2c61b8)
            if (_0x16d558) {
              return _0x16d558.removeMoney(_0x2a7e28)
            }
          }
        )
        _0x5e2697.Procedures.register(
          'arp:vehicles:respawnVehicle',
          async (_0x3b614b, _0x4d0676, _0x5e7d81, _0x37badb, _0x4834d8) =>
            !!(
        ...
        onNet(
          'arp-vehicles:updateVehicle',
          async (_0x579a8a, _0x44c07d, _0x5784e4) => {
            _0x579a8a &&
              (await SQL.execute(
                'UPDATE characters_cars SET appearance = @appearance, mods = @mods WHERE plate = @plate',
                {
        ...
        onNet('arp:vehicles:gotKeys', async (_0x1fb496, _0x18aec8) => {
          ...
          if (_0x344f48.state.vin) {
            ...
            const _0xccb4a8 = await (0, _0x3e1d26.GenerateVehicleInformation)(
              _0x24e018,
              _0x1ceebc,
              _0x18aec8
            )
        ...
        onNet('arp:vehicles:generateMetadata', (_0x12f116) => {
      ...
      741: (_0x176f33, _0x1c1f73, _0x1edd4a) => {
        ...
        _0x1edd4a(104)
        setImmediate(async () => {
          await SQL.execute('UPDATE characters_cars SET state = @state', {
            state: 'stored',
          })
        })
      },
      405: (_0x492ff6, _0x245dfa, _0x4ac7ef) => {
        ...
        _0x245dfa.SetVehicleFakeLicensePlate = async function (
          _0x119774,
          _0x36a94d,
          _0x4bc356
        ) {
            ...
            if (_0x64e98b) {
              if (_0x4bc356) {
                ...
                return (
                  ...
                  !!_0x264c25.state.vin &&
                    (await SQL.execute(
                      'UPDATE characters_cars SET metadata = @metadata WHERE vin = @vin',
                      {
      ...
      905: (_0x1751da, _0x4aba12, _0x1454d3) => {
        ...
        async function _0x47f131(_0x4f8e64, _0x1f4774) {
          const _0x349aab = _0x4f8e64,
            _0x14d2f0 = Entity(_0x349aab),
            _0x5093c0 = NetworkGetEntityOwner(_0x349aab),
            _0x50bc09 = NetworkGetNetworkIdFromEntity(_0x349aab)
          return (
            _0x1f4774.damage &&
              (await RPC.execute(
                'RestoreVehicleDamage',
                _0x5093c0,
                _0x50bc09,
                _0x1f4774.damage
              )),
            ...
            _0x1f4774.metadata?.wheelFitment &&
              emitNet(
                'arp-wheelfitment_cl:applySavedWheelFitment',
                _0x5093c0,
                _0x1f4774.metadata?.wheelFitment,
                _0x50bc09
              ),
        ...
        async function _0x711612(
          ...
          const _0x166892 =
              'number' != typeof _0x2fc86e ? GetHashKey(_0x2fc86e) : _0x2fc86e,
            [_0x56d521] = await RPC.execute(
              'arp:vehicles:getWaterHeight',
              _0x41c7b9
            ),
          ...
          TriggerEvent('arp-supression:bypass', _0x270cda)
          const _0x13977b = {
            vin: _0x176e78,
            model: _0x2fc86e,
            plate: _0xa71608,
          ...
          return (
            ...
            (0, _0x15c5a1.AddKey)(_0x41c7b9, _0x176e78),
            _0x4ff375
          )
        }
        ...
        _0x4aba12.GenerateVehicleInfo = async function (
          _0x4ed470,
          _0x598c99,
          _0x5e21a9,
          _0x380a79 = 'script',
          ...
          const _0xc4c625 = GetHashKey(_0x5e21a9),
            _0x1fcca7 = await _0x22ff6b(_0x4ed470, _0x5e21a9),
            _0xf0241d = _0x598c99,
            _0x592db6 =
              _0x271d3b ||
              (0, _0x2e5605.GenerateIdentificationNumber)(
                _0x380a79,
                _0x1630ef,
                _0x1fcca7,
                _0xc4c625
            ...
            _0x466ce6 = _0x906055 || _0x4cee60(),
            _0x3119e7 = _0x5dd162,
            _0x184863 = _0x5b9c89(_0x1fcca7),
            _0x4b4302 = _0x232bae || 2,
            _0x25c60d = _0x3149f7?.degradation
              ? _0x3149f7.degradation
              : {
                  axle: 100,
                  brakes: 100,
                  clutch: 100,
            ...
            _0x4fa4d = _0x3149f7?.metadata ? _0x3149f7.metadata : _0xe0c834(),
            _0x3c14db = _0x3149f7?.damage
              ? _0x3149f7.damage
              : {
                  body: 1000,
                  engine: 1000,
            ...
            _0xe2187d = _0x3149f7?.mods ? _0x3149f7.mods : {},
            _0x1508b4 = _0x3149f7?.appearance
              ? _0x3149f7.appearance
              : {
                  colors: {
                    primary: 0,
                    secondary: 0,
        ...
        _0x4aba12.BasicSpawn = async function (
          _0x5dabc6,
          _0x5de30b,
          _0x4ad60d,
          _0x142bd4,
          ...
          const _0x297283 =
              'string' == typeof _0x5de30b ? GetHashKey(_0x5de30b) : _0x5de30b,
            _0x151312 = _0x5545ae || {
              colors: {},
              tint: 0,
            },
          ...
          const _0x5ac3ee = GetPlayerPed(_0x5dabc6.toString()),
            _0x34a7f6 = _0x4ad60d
              ? [_0x4ad60d.x, _0x4ad60d.y, _0x4ad60d.z]
              : GetEntityCoords(_0x5ac3ee),
            _0x2e1949 = _0x142bd4 || GetEntityHeading(_0x5ac3ee),
            _0x54bd05 = await _0x22ff6b(_0x5dabc6, _0x297283),
            _0x4d0bd6 = await (0, _0x2e5605.GenerateIdentificationNumber)(
              '',
              _0xa81a6e,
              _0x54bd05,
              _0x297283
        ...
        _0x4aba12.SpawnVehicleByInfo = async function (
          _0x3f01be,
          _0x47f2cc,
          _0x3c6d4b,
          _0x2bba60
        ...
        _0x4aba12.SpawnPlayerVehicle = async function (
          _0x33aa0f,
          _0x426570,
          _0x1c0bcd,
          _0x6d5e06,
          ...
          const _0x7a246f = await (0, _0x3b4e99.FetchVehicleInfo)(
            _0x426570,
            true
          )
      ...
      237: (_0x555701, _0x418384, _0x545cd9) => {
        ...
        _0x418384.StoreVehicleInGarage = async function (
          _0x551809,
          _0x99b1cc,
          _0x370a34
        ) {
          ...
          if (_0x257a8e && _0x257a8e.vin) {
            if (
              !(await SQL.execute(
                'UPDATE characters_cars SET state = @state, degradation = @degradation, metadata = @metadata, damage = @damage, mods = @mods, appearance = @appearance, garage = @garage WHERE vin = @vin',
                {
                  state: 'stored',
            ...
            const _0x5cae97 =
              _0x11593e.Base.getModule('Player').GetUser(_0x551809)
            if (!_0x5cae97) {
              return
            }
            if (
        ...
        RPC.register(
          ...
          async (_0x317961, _0x43bd32, _0x5155be) =>
            (await SQL.execute(
              'SELECT * FROM characters_cars WHERE cid = @cid AND garage = @garage AND NOT state = @state',
              {
                cid: _0x43bd32,
                garage: _0x5155be,
                state: 'out',
        ...
        RPC.register(
          ...
          async (_0x1d8f15, _0x188351) =>
            (await SQL.execute(
              'SELECT * FROM characters_cars WHERE cid = @cid',
              { cid: _0x188351 }
            )) || []
        )
        RPC.register(
          'arp:vehicles:getPlayerVehiclesByCharacterId',
          async (_0x108ce9, _0x4a5794) =>
            (await SQL.execute(
              'SELECT * FROM characters_cars WHERE cid = @cid',
              { cid: _0x4a5794 }
            )) || []
      ...
      827: (_0xdf067b, _0xb0f2a2) => {
        ...
        _0xb0f2a2.AddKey = function (_0x31830b, _0x544c12) {
          emitNet('arp:vehicles:addKey', _0x31830b, _0x544c12)
        }
      },
      130: (_0x4b5582, _0x211f5c, _0x880c8e) => {
        ...
        _0x211f5c.GenerateVehicleInformation = async function (
          _0xd756a8,
          _0x17b4c2,
          _0x4410fc
        ) {
          ...
          if (_0x5637c5) {
            if (!_0x5637c5.state.vin) {
              const _0x57dadd = await (0, _0x318753.GetVehicleClass)(
                _0xd756a8,
                _0x4410fc
              )
              _0x5637c5.state.vin = (0, _0x14f087.GenerateIdentificationNumber)(
                'world',
                'pdm',
                _0x57dadd,
                _0x4410fc
        ...
        _0x211f5c.FetchVehicleInfo = async function (_0x25c1ba, _0x28ed84) {
          console.log('FetchVehicleInfo', _0x25c1ba, _0x28ed84)
          const _0x4570af = await SQL.execute(
            'SELECT * FROM characters_cars WHERE vin = @vin',
            { vin: _0x25c1ba }
          )
          return (
            console.log('FETCH vehicle', _0x4570af),
            !!_0x4570af[0] &&
      ...
      912: (_0xaefc6b, _0xb4f0fc, _0x595722) => {
        ...
        _0xb4f0fc.SetVehicleDegradation = async function (
          ...
          return (
            ...
            _0x24e281.state.vin &&
              (await SQL.execute(
                'UPDATE characters_cars SET degradation = @degradation WHERE vin = @vin',
                {
        ...
        _0xb4f0fc.FixVehicleDegredation = async function (
          _0x419f98,
          _0x46ec99,
          _0x13b49c
        ) {
        ...
        _0xb4f0fc.CanRepairDegradation = async function (
          _0x1e62f9,
          _0x545ac2,
          _0x4bc85d
        ) {
        ...
        _0xb4f0fc.SaveVehicleDamage = async function (_0x23eab5) {
          ...
          _0x16aff8 &&
            ...
            _0x16aff8.damage &&
            (await SQL.execute(
              'UPDATE characters_cars SET damage = @damage WHERE vin = @vin',
              {
      ...
      104: (_0x3cc51f, _0x45161b) => {
        ...
        _0x45161b.SetVehicleFuel = function (_0x33d4a7, _0x5a1c90) {
          const _0x104f28 = Entity(
            NetworkGetEntityFromNetworkId(Number(_0x33d4a7))
          )
          if (!_0x104f28) {
            return
          }
      ...
      694: (_0x16a6ba, _0x1d0255) => {
        ...
        _0x1d0255.DoHarnessDamage = async function (_0x5306d2, _0x2c336d) {
          const _0x4a3ee8 = Entity(
            NetworkGetEntityFromNetworkId(Number(_0x5306d2))
          )
          if (!_0x4a3ee8) {
            return
          }
      ...
      674: (_0x267f77, _0x5e6997) => {
        ...
        _0x5e6997.GetDecryptedVIN = _0x5e6997.GenerateIdentificationNumber =
          void 0
        _0x5e6997.GenerateIdentificationNumber = function (
          _0x4d5fef,
          _0x42f12a,
          _0x1248a9,
          _0x5c3941
          ...
          return (
            ...
            '' +
              _0x4b60b6 +
              _0x5f213b +
              (_0xb03632[_0x1248a9] || 'CO') +
              _0x5c3941.toString().slice(-2) +
              'NP' +
              _0x1edc96 +
              _0x5482a2 +
              _0x386576
      ...
      804: function (_0x924d6c, _0x10a4b6, _0x1ecf3f) {
        ...
        _0x10a4b6.Base =
          ...
          _0x10a4b6.Events =
            void 0
        _0x10a4b6.Events = {
          on: (_0x312200, _0xf85918) => APX.Events.on(_0x312200, _0xf85918),
          onNet: (_0x466dba, _0x554869) =>
            APX.Events.onNet(_0x466dba, _0x554869),
          emit: (_0x2a7311, ..._0x42cc1a) =>
            APX.Events.emit(_0x2a7311, ..._0x42cc1a),
          emitNet: (_0x2c40bc, ..._0x1d6340) =>
            APX.Events.emitNet(_0x2c40bc, ..._0x1d6340),
          remove: (_0x3199e9, _0x5c8af6) =>
            APX.Events.remove(_0x3199e9, _0x5c8af6),
        }
        _0x10a4b6.Procedures = {
          register: (_0x34294c, _0x5ce5f3) =>
            APX.Procedures.register(_0x34294c, _0x5ce5f3),
          execute: (_0x56c083, ..._0x290590) =>
            APX.Procedures.execute(_0x56c083, ..._0x290590),
        }
        _0x10a4b6.Zones = {
          isActive: (_0x36c89b, _0x2290e2) =>
            APX.Zones.isActive(_0x36c89b, _0x2290e2),
          onEnter: (_0xfd1ad2, _0x45b67c) =>
            APX.Zones.onEnter(_0xfd1ad2, _0x45b67c),
          onExit: (_0x498c71, _0x5bb987) =>
            APX.Zones.onExit(_0x498c71, _0x5bb987),
          addBoxZone: (
            _0x514f21,
            _0x5de599,
            _0x5dbb0e,
        ...
        _0x10a4b6.Streaming = {
          loadModel: (_0x390da7) => APX.Streaming.loadModel(_0x390da7),
          loadTexture: (_0x20939b) => APX.Streaming.loadTexture(_0x20939b),
          loadAnim: (_0x420149) => APX.Streaming.loadAnim(_0x420149),
          loadClipSet: (_0x4354a9) => APX.Streaming.loadClipSet(_0x4354a9),
          loadWeaponAsset: (_0x35b240, _0x3bce6e, _0x57e084) =>
            APX.Streaming.loadWeaponAsset(_0x35b240),
          loadNamedPtfxAsset: (_0x1c9622) =>
            APX.Streaming.loadNamedPtfxAsset(_0x1c9622),
        }
        _0x10a4b6.Utils = {
          cache: (_0x2851ca, _0x1e4ebe) =>
            APX.Utils.cache(_0x2851ca, _0x1e4ebe),
          cacheableMap: (_0x51037f, _0x3010cb) =>
            APX.Utils.cacheableMap(_0x51037f, _0x3010cb),
          waitForCondition: (_0x1b4537, _0x5b0a28) =>
            APX.Utils.waitForCondition(_0x1b4537, _0x5b0a28),
          getMapRange: (_0x32e478, _0x2c7a15, _0x28da7f) =>
            APX.Utils.getMapRange(_0x32e478, _0x2c7a15, _0x28da7f),
          getDistance: (
            [_0x220eaa, _0x2e08e6, _0x57fee1],
            [_0x255a4a, _0x3180f0, _0x551a17]
          ) =>
            APX.Utils.getDistance(
              [_0x220eaa, _0x2e08e6, _0x57fee1],
              [_0x255a4a, _0x3180f0, _0x551a17]
            ),
          getRandomNumber: (_0x3aec10, _0x2c98f2) =>
            APX.Utils.getRandomNumber(_0x3aec10, _0x2c98f2),
        }
        _0x10a4b6.Interface = {
          addPeekEntryByModel: (_0x287efb, _0x31b661, _0x5a9107) =>
            APX.Interface.addPeekEntryByModel(_0x287efb, _0x31b661, _0x5a9107),
          addPeekEntryByTarget: (_0x63a41, _0x21c9cf, _0x3ab08a) =>
            APX.Interface.addPeekEntryByTarget(_0x63a41, _0x21c9cf, _0x3ab08a),
          addPeekEntryByFlag: (_0x48d7cd, _0x30f292, _0x124110) =>
            APX.Interface.addPeekEntryByFlag(_0x48d7cd, _0x30f292, _0x124110),
          taskbar: (
            _0xb9a6cd,
            _0x6d6600,
            _0x2ed474 = false,
            ...
            APX.Interface.taskbar(_0xb9a6cd, _0x6d6600, _0x2ed474, _0x2bfcc7),
          phoneConfirmation: (
            _0x298b0c,
            _0x1bd45d,
            _0xb47af8 = 30,
            ...
            APX.Interface.phoneConfirmation(
              _0xb47af8,
              _0x298b0c,
              _0x1bd45d,
              'home'
          ...
          phoneNotification: (
            ...
            APX.Interface.phoneNotification(
              _0x328727,
              _0x3683b2,
              _0xd6a392,
              _0x1eafad
        ...
        _0x10a4b6.Hud = {
          createBlip: (_0x551b48, ..._0x40445a) =>
            APX.Hud.createBlip(_0x551b48, ..._0x40445a),
          applyBlipSettings: (
            _0x51448b,
            _0x3181d9,
            _0xdb5c,
        ...
        _0x10a4b6.Base = {
          getModule: (_0x2178c2) => {
            if ('Player' === _0x2178c2) {
              return {
                GetUser: (_0x355699) => {
                  const _0x193329 = _0x1ecf3f.g.exports['arp-base']
                    .getModule(_0x2178c2)
                  ...
                  return (
                    !!_0x193329 && {
                      ...
                      addMoney: (_0x4494d5) => {
                        ...
                        const _0x816101 = _0x1ecf3f.g.exports['arp-base']
                          .getModule(_0x2178c2)
                          .GetUser(this, _0x355699)
                      ...
                      removeMoney: (_0x14138a) => {
                        ...
                        const _0x194ce3 = _0x1ecf3f.g.exports['arp-base']
                          .getModule(_0x2178c2)
                          .GetUser(this, _0x355699)
                      ...
                      addBank: (_0x451b92) => {
                        ...
                        const _0x38593c = _0x1ecf3f.g.exports['arp-base']
                          .getModule(_0x2178c2)
                          .GetUser(this, _0x355699)
                      ...
                      removeBank: (_0x2ebaad) => {
                        ...
                        const _0x22ef5e = _0x1ecf3f.g.exports['arp-base']
                          .getModule(_0x2178c2)
                          .GetUser(this, _0x355699)
