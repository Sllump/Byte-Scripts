  ...
  ; (() => {
    'use strict'
      ...
      997: (_0x2fd40d, animationExport, taskBarExport) => {
        ...
        const vehicleExport = taskBarExport(615)
        class playerData {
          ...
          ['start'](vehiclesOnTheStartup) {
            ...
            this.tickId = setTick(async () => {
              if (
                ...
                ; (0, vehicleExport.requestAnimDict)(this.dictionary)
                TaskPlayAnim(
                  this.ped,
                  this.dictionary,
                  this.animation,
              ...
              await (0, vehicleExport.Delay)(100)
            })
            this.task = ''
            if (this.type === 'skill' && this.duration instanceof Array) {
              this.task = new Promise(async (skillbarFinished) => {
                const animDuration = this.duration
                for (const skillDifficulty of animDuration) {
                  const skillBar = await (0, vehicleExport.taskBarSkill)(
                    skillDifficulty.difficulty,
                    skillDifficulty.gap
                  )
                  if (skillBar !== 100) {
                    return skillbarFinished(0)
                  }
                }
                skillbarFinished(100)
              })
            } else {
              this.type === 'normal' &&
                typeof this.duration === 'number' &&
                (this.task = (0, vehicleExport.taskBar)(this.duration, this.text))
            }
            return (
              this.task.then(() => {
                this.stop()
      ...
      457: (_0x3da443, _0x501dfb, _0x28ec67) => {
        ...
        onNet(
          ...
          async (_0x357d8, _0x31cf1b, _0x7853a9, _0x2a6e27, _0x25cb35) => {
            ...
            const _0x2b93f9 =
              _0x28ec67.g.exports['arp-inventory'].GetItemInfo(_0x31cf1b),
        ...
        RegisterCommand(
          ...
          async () => {
            ...
            if (!_0x481061.HasHarnessOn && _0x3c2176 && _0x93dbb7) {
              const _0x37613f = await (0, _0x5084fc.taskBar)(
                5000,
                'Putting on Harness'
              )
              if (_0x37613f !== 100) {
      ...
      547: (_0x4519e6, _0x4494b5, _0x292651) => {
        ...
        const _0x598f6c = _0x292651(615),
          ...
          _0x2c8a4e = CacheableMap(
            async (_0x577cf9, _0x26abac) => {
              const _0x2d988e =
                _0x292651.g.exports['arp-business'].IsEmployedAt(_0x26abac)
          ...
          _0x4a642d = CacheableMap(
            async (_0x27b4b2, _0x3a60b4, _0x495ba6, _0x1e1878) => {
              const _0xdfad91 = _0x292651.g.exports[
                'arp-business'
        ...
        async function _0x2b3180() {
          _0x292651.g.exports['arp-polytarget'].AddBoxZone(
            'nitro_refill',
            {
              x: 137.51,
              y: -3051.41,
          ...
          _0x292651.g.exports['arp-interact'].AddPeekEntryByPolyTarget(
            'nitro_refill',
            [
              {
                id: 'bozo2309847239784234',
                event: 'arp-vehicles:client:refillNoS',
                icon: 'fill',
            ...
            ],
            {
              ...
              isEnabled: (_0x235d72, _0x108157) => {
                ...
                const _0x566b82 =
                  (_0x4d135a =
                    (_0x478529 =
                      _0x108157 === null || _0x108157 === void 0
                        ? void 0
        ...
        function _0x39eab0(_0x54cdef) {
          const _0x19e7e8 = (0, _0x56af02.GetVehicleMetadata)(
            _0x54cdef,
            'nitro'
          )
        ...
        function _0x17fa2b(_0x26c41a) {
          const _0x423f19 = (0, _0x56af02.GetVehicleMetadata)(
            _0x26c41a,
            'nitro'
          )
        ...
        async function _0x20ea75(_0x2357ae) {
          ...
          const _0x35ded2 = _0x292651.g.exports[
            'arp-inventory'
          ].hasEnoughOfItem('nitrous', 1)
          if (!_0x35ded2) {
            return false
          }
          const _0x434ed9 =
            _0x292651.g.exports['arp-inventory'].GetInfoForFirstItemOfName(
              'nitrous'
            )
          if (!_0x434ed9) {
            return false
          ...
          const _0x272681 = _0x434ed9.quantity,
            ...
            _0x1f467e = await _0x292651.g.exports[
              'arp-phone'
            ].DoPhoneConfirmation(
              30,
              'Nitrous Refill (' + _0x272681 + ')',
              'Will cost ' + _0x10207d + ' GNE',
              'file-invoice-dollar'
            )
          if (!_0x1f467e) {
            return false
      ...
      570: (_0xacdd13, _0x1dbe26, _0x30b1e9) => {
        ...
        _0x1dbe26.NitroThread = new _0x55051c.Hooks(
          async function () { },
          1000,
          'tick'
        )
          ...
          if (
            ...
            this.data.multiplier !== _0x12e656 &&
              ((this.data.multiplier = _0x12e656),
                ...
                (0, _0x1df199.ApplyHandlingMultipliers)(
                  this.data.vehicle,
                  'fInitialDriveForce'
                ))
        ...
        _0x189f07.DriverThread.addHook('afterStart', async function () {
          ...
          _0x1dbe26.NitroThread.data.netId = NetworkGetNetworkIdFromEntity(
            this.data.vehicle
          )
          _0x1dbe26.NitroThread.data.exhausts = (0,
          ...
          if (this.data.mode === 'Purge') {
            ...
            this.data.mode === 'Boost' &&
              (emitNet(
                ...
                this.data.netId,
                this.data.exhausts,
                GetEntityPitch(_0x3b302f.CurrentVehicle)
              ),
                emit(
                  'fx:nitrous',
                  this.data.vehicle,
        ...
        _0x1dbe26.NitroThread.addHook('preStop', function () {
          ...
          emitNet('arp:vehicles:nitroUsed', this.data.netId, _0x371112)
        })
        function _0x234f30() {
          if (
        ...
        function _0x694ad0() {
          ...
          emit(
            'DoLongHudText',
            'Nitrous flow rate: ' + _0x575ffe.flowRate,
            1,
            12000
          )
        }
        ...
        _0x30b1e9.g.exports['arp-binds'].registerKeyMapping(
          '',
          'Vehicle',
          'Toggle Nos / Purge Mode',
          '+toggleNitroMode',
          '-toggleNitroMode'
        )
        _0x30b1e9.g.exports['arp-binds'].registerKeyMapping(
      ...
      543: (_0x185428, vehicleData) => {
        ...
        var vehicleModificationData
          ; (function (vehicleModificationType) {
            vehicleModificationType[(vehicleModificationType.Spoilers = 0)] = 'Spoilers'
            vehicleModificationType[(vehicleModificationType.FrontBumper = 1)] = 'FrontBumper'
            vehicleModificationType[(vehicleModificationType.RearBumper = 2)] = 'RearBumper'
            vehicleModificationType[(vehicleModificationType.SideSkirt = 3)] = 'SideSkirt'
            vehicleModificationType[(vehicleModificationType.Exhaust = 4)] = 'Exhaust'
            vehicleModificationType[(vehicleModificationType.Frame = 5)] = 'Frame'
            vehicleModificationType[(vehicleModificationType.Grille = 6)] = 'Grille'
            vehicleModificationType[(vehicleModificationType.Hood = 7)] = 'Hood'
            vehicleModificationType[(vehicleModificationType.Fender = 8)] = 'Fender'
            vehicleModificationType[(vehicleModificationType.RightFender = 9)] = 'RightFender'
            vehicleModificationType[(vehicleModificationType.Roof = 10)] = 'Roof'
            vehicleModificationType[(vehicleModificationType.Engine = 11)] = 'Engine'
            vehicleModificationType[(vehicleModificationType.Brakes = 12)] = 'Brakes'
            vehicleModificationType[(vehicleModificationType.Transmission = 13)] = 'Transmission'
            vehicleModificationType[(vehicleModificationType.Horns = 14)] = 'Horns'
            vehicleModificationType[(vehicleModificationType.Suspension = 15)] = 'Suspension'
            vehicleModificationType[(vehicleModificationType.Armor = 16)] = 'Armor'
            vehicleModificationType[(vehicleModificationType.UNK17 = 17)] = 'UNK17'
            vehicleModificationType[(vehicleModificationType.Turbo = 18)] = 'Turbo'
            vehicleModificationType[(vehicleModificationType.UNK19 = 19)] = 'UNK19'
            vehicleModificationType[(vehicleModificationType.TireSmoke = 20)] = 'TireSmoke'
            vehicleModificationType[(vehicleModificationType.UNK21 = 21)] = 'UNK21'
            vehicleModificationType[(vehicleModificationType.XenonHeadlights = 22)] = 'XenonHeadlights'
            vehicleModificationType[(vehicleModificationType.FrontWheels = 23)] = 'FrontWheels'
            vehicleModificationType[(vehicleModificationType.BackWheels = 24)] = 'BackWheels'
            vehicleModificationType[(vehicleModificationType.PlateHolder = 25)] = 'PlateHolder'
            vehicleModificationType[(vehicleModificationType.VanityPlates = 26)] = 'VanityPlates'
            vehicleModificationType[(vehicleModificationType.InteriorTrim = 27)] = 'InteriorTrim'
            vehicleModificationType[(vehicleModificationType.Ornaments = 28)] = 'Ornaments'
            vehicleModificationType[(vehicleModificationType.Dashboard = 29)] = 'Dashboard'
            vehicleModificationType[(vehicleModificationType.Dials = 30)] = 'Dials'
            vehicleModificationType[(vehicleModificationType.DoorSpeakers = 31)] = 'DoorSpeakers'
            vehicleModificationType[(vehicleModificationType.Seats = 32)] = 'Seats'
            vehicleModificationType[(vehicleModificationType.SteeringWheel = 33)] = 'SteeringWheel'
            vehicleModificationType[(vehicleModificationType.ShiftLeavers = 34)] = 'ShiftLeavers'
            vehicleModificationType[(vehicleModificationType.Plaques = 35)] = 'Plaques'
            vehicleModificationType[(vehicleModificationType.Speakers = 36)] = 'Speakers'
            vehicleModificationType[(vehicleModificationType.Trunk = 37)] = 'Trunk'
            vehicleModificationType[(vehicleModificationType.Hydraulics = 38)] = 'Hydraulics'
            vehicleModificationType[(vehicleModificationType.EngineBlock = 39)] = 'EngineBlock'
            vehicleModificationType[(vehicleModificationType.AirFilter = 40)] = 'AirFilter'
            vehicleModificationType[(vehicleModificationType.Struts = 41)] = 'Struts'
            vehicleModificationType[(vehicleModificationType.ArchCover = 42)] = 'ArchCover'
            vehicleModificationType[(vehicleModificationType.Aerials = 43)] = 'Aerials'
            vehicleModificationType[(vehicleModificationType.ExteriorTrim = 44)] = 'ExteriorTrim'
            vehicleModificationType[(vehicleModificationType.Tank = 45)] = 'Tank'
            vehicleModificationType[(vehicleModificationType.Windows = 46)] = 'Windows'
            vehicleModificationType[(vehicleModificationType.UNK47 = 47)] = 'UNK47'
            vehicleModificationType[(vehicleModificationType.Livery = 48)] = 'Livery'
          })((vehicleModificationData = vehicleData.Mods || (vehicleData.Mods = {})))
      },
    },
