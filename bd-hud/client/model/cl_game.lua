...
-- RegisterNetEvent("bd-spawn:characterSpawned")
-- AddEventHandler("bd-spawn:characterSpawned", function()
--     charSpawned = true
...
-- RegisterNetEvent("bd-hud:initHud")
-- AddEventHandler("bd-hud:initHud", function()
--   print("[bd-hud] Init hud...")
...
--   end
--   if hasStarted then
--     print("[bd-hud] Fully started, and init.")
--     --Wait(100)
--     local initialHudSettings = GetPreferences()
--     if initialHudSettings ~= "{}" then
--       sendAppEvent("preferences", initialHudSettings)
--       exports["bd-interface"]:sendAppEvent('preferences', initialHudSettings)
--       TriggerEvent("bd-preferences:setPreferences", initialHudSettings)
--     end
...
-- RegisterNetEvent('bd-admin:maxstats')
-- AddEventHandler('bd-admin:maxstats', function()
--     currentValues["thirst"] = 100
--     currentValues["hunger"] = 100 
--     TriggerEvent("heal", PlayerPedId())
--     TriggerEvent("Hospital:HealInjuries", PlayerPedId(),true) 
--     TriggerServerEvent("bd-death:reviveSV", source)
...
--   TriggerEvent("bd-buffs:addUIBuff", { buffedHealth = true, buffedArmor = true })
--   Citizen.CreateThread(function()
--     Citizen.Wait(60000 * 60 * 6) -- 3hr
--     citrineStartTime = 0
--     TriggerEvent("bd-buffs:addUIBuff", { buffedHealth = false, buffedArmor = false })
--   end)
-- end)
