...
RegisterNUICallback('bd-hud:hudSetPreferences', function(data, cb)
    ...
    TriggerEvent("bd-preferences:setPreferences", data)
end)

AddEventHandler('bd-preferences:setPreferences', function(pData)
    exports["bd-interface"]:sendAppEvent('preferences', pData)
end)
...
AddEventHandler("bd-hud:watch", function()
...
AddEventHandler("bd-hud:watch:reset", function()
    showCompassFromWatch = false
    toggleCompass()
end)

RegisterNetEvent('bd-inventory:itemCheck')
AddEventHandler('bd-inventory:itemCheck', function (item, hasItem, quantity)
...
RegisterNetEvent("bd-hud:changeRange")
AddEventHandler("bd-hud:changeRange", function(proximity)
    sendAppEvent("hud", {
        voiceRange = tonumber(proximity)
    })
end)
...
AddEventHandler('onClientResourceStart', function(resourceName)
    ...
    --TriggerEvent("bd-spawn:characterSpawned")
...
Citizen.CreateThread(function ()
	while true do
        ...
        local pRadioActive = exports['bd-voice']:pRadioActive()
...
RegisterNetEvent("bd-admin:currentDevmode")
AddEventHandler("bd-admin:currentDevmode", function(devmode)
    setGameValue("modeDev", devmode)
end)

RegisterNetEvent("bd-admin:currentDebug")
AddEventHandler("bd-admin:currentDebug", function(debugToggle)
...
RegisterNetEvent('bd-boosting:client:setBoostCompletions')
AddEventHandler('bd-boosting:client:setBoostCompletions', function (pAmount)
...
function getFuel()
    fuel = exports["bd-vehicles"]:CurrentFuel() or 50
end
    ...
    Citizen.CreateThread(function()
        while engineOn do
            ...
            if GetPedInVehicleSeat(veh, -1) == PlayerPedId() then
                harnessDurability = exports["bd-vehicles"]:GetVehicleMetadata(veh, 'harness')
            end
...
-- RegisterNetEvent('bd-hud:show_weapon_out')
-- AddEventHandler('bd-hud:show_weapon_out', function()
--     sendAppEvent("hud", {
--         isArmed = true
--     })
-- end)

-- RegisterNetEvent('bd-hud:hide_weapon_out')
-- AddEventHandler('bd-hud:hide_weapon_out', function()
--     sendAppEvent("hud", {
--         isArmed = false
--     })
-- end)
...
RegisterNetEvent('bd-weapons:client:showWeaponFireRate')
AddEventHandler('bd-weapons:client:showWeaponFireRate', function (pToggle)
...
--                         --end
--                         Fuel = exports["bd-vehicles"]:CurrentFuel()
--                     else
--                         --Fuel = DecorGetInt(veh, "GetVehicleCurrentFuel")
--                         Fuel = exports["bd-vehicles"]:CurrentFuel()
--                     end
...
--                     --DecorSetInt(veh, "GetVehicleCurrentFuel", fRound(Fuel))
--                     exports["bd-vehicles"]:SetVehicleFuel(veh, fRound(Fuel))
--                     lasteupdate = 0
--                 end
...
function getVehicleInDirection(coordFrom, coordTo)
  ...
  RegisterNetEvent("bd-hud:jerry_can:refuel")
  AddEventHandler("bd-hud:jerry_can:refuel",function()
      vehicleCurrentFuel = exports["bd-vehicles"]:CurrentFuel(veh) --DecorGetInt(veh, "GetVehicleCurrentFuel")
      if exports['bd-inventory']:hasEnoughOfItem('883325847', 1) then
        local timer = (100 - vehicleCurrentFuel) * 400
        refillVehicle()
        local finished = exports["bd-taskbar"]:taskBar(timer,"Refueling")
        local veh = getVehicleClosestToMe()
    
        if finished == 100 then
            if exports['bd-inventory']:hasEnoughOfItem('883325847', 1) then
                --DecorSetInt(veh, "GetVehicleCurrentFuel", 100)
                exports["bd-vehicles"]:SetVehicleFuel(veh, 100)
                TriggerEvent('inventory:removeItem', '883325847', 1)
            else
                TriggerEvent('DoLongHudText', 'Try again!', 2)
            end
    
            local vehicleCurrentFuel = exports["bd-vehicles"]:CurrentFuel(veh) --DecorGetInt(veh, "GetVehicleCurrentFuel")
            ...
            exports["bd-vehicles"]:SetVehicleFuel(veh, endFuel)
