...
RegisterNUICallback("cool-hud:setKVPValue", function(data, cb)
  -- INCOMING
  -- data.key = key
  -- data.value = value
  ...
  TriggerEvent("cool-hud:settings", data.key, data.value)
...
RegisterNUICallback("cool-hud:getKVPValue", function(data, cb)
  -- INCOMING
  -- data.key = key
...
function GetPreferences()
  local result = GetResourceKvpString('cool-preferences')
