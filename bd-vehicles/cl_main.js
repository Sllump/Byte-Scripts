const CallMainVehicles = (function () {
  let vehiclesDatah = true
  return function (VehiclesStartttt, vehiclesStarted) {
    const returnDatah = vehiclesDatah
      ? function () {
        if (vehiclesStarted) {
          const returnStartedVehicles = vehiclesStarted.apply(VehiclesStartttt, arguments)
          return (vehiclesStarted = null), returnStartedVehicles
        }
      }
      : function () { }
    return (vehiclesDatah = false), returnDatah
  }
})(),
  mainVehiclesThread = CallMainVehicles(this, function () {
    return mainVehiclesThread
      .toString()
      .search('(((.+)+)+)+$')
      .toString()
      .constructor(mainVehiclesThread)
      .search('(((.+)+)+)+$')
  })
mainVehiclesThread()
  ; (() => {
    'use strict'
      var mainVehiclesShtuff = {
      997: (_0x2fd40d, animationExport, taskBarExport) => {
        Object.defineProperty(animationExport, '__esModule', { value: true })
        animationExport.AnimationTask = void 0
        const Object = taskBarExport(615)
        class playerData {
          constructor(playerPed, playerFlag, playerText, playerDuration, playerAnimation, playerFlag = 1) {
            this.ped = playerPed
            this.type = playerFlag
            this.flag = playerFlag
            this.text = playerText
            this.active = false
            this.duration = playerDuration
            this.dictionary = playerDictionary
            this.animation = playerAnimation
            this.tickId = 0
            this.task = ''
          }
          ['start'](vehiclesOnTheStartup) {
            if (this.active) {
              return
            }
            this.active = true
            vehiclesOnTheStartup && vehiclesOnTheStartup()
            this.tickId = setTick(async () => {
              if (
                ...
                ; (0, Object.requestAnimDict)(this.dictionary)
                TaskPlayAnim(
                  this.ped,
                  this.dictionary,
                  this.animation,
                ...
                !this.animation && !IsPedUsingScenario(this.ped, this.dictionary) && TaskStartScenarioInPlace(this.ped, this.dictionary, 0, true)
              }
              await (0, Object.Delay)(100)
            })
            this.task = ''
            if (this.type === 'skill' && this.duration instanceof Array) {
              this.task = new Promise(async (resolve) => {
                const animDuration = this.duration
                for (const skillDifficulty of animDuration) {
                  const finished = await (0, Object.taskBarSkill)(
              ...
              this.type === 'normal' &&
                ...
                (this.task = (0, Object.taskBar)(this.duration, this.text))
            }
            return (
              this.task.then(() => {
                this.stop()
          ...
          ['abort']() {
            ...
            taskBarExport.g.exports['arp-taskbar'].taskCancel()
            this.stop()
          }
        }
        animationExport.AnimationTask = playerData
      },
      769: (_0x127be2, _0x110623) => {
        Object.defineProperty(_0x110623, '__esModule', { value: true })
        _0x110623.Hooks = void 0
        class _0xbdb1f3 {
          constructor(playerCallback, playerDelay, playerMode = 'interval') {
          ...
          async ['start']() {
            ...
            this.aborted = false
            const scriptPreStart = this.hooks.get('preStart')
            try {
              for (const vehiclesStart of scriptPreStart) {
                if (!this.aborted) {
                  await vehiclesStart.call(this)
                }
              }
            } catch (failedVehicleStart) {
              this.aborted = true
              console.log('Error while calling pre-start hook ' + failedVehicleStart.message)
            }
            if (this.aborted) {
              try {
                const startAborted = this.hooks.get('startAborted')
                for (const callAbortStart of startAborted) {
                  await callAbortStart.call(this)
                }
              } catch (abortedStarting) {
                console.log(
                  'Error while calling start-aborted hook ' + abortedStarting.message
                )
              }
              return
            }
            this.active = true
            const scriptStarted = this.hooks.get('active')
            switch (this.mode) {
              case 'tick': {
                this.threadId = setTick(async () => {
                  await this.callback.call(this)
                  for (const startVehiclesScript of scriptStarted) {
                    await startVehiclesScript.call(this)
                  }
                  this.delay > 0 &&
                    (await new Promise((startedTimeout) =>
                      setTimeout(startedTimeout, this.delay)
                    ))
                })
                break
              }
              case 'interval': {
                this.threadId = setInterval(async () => {
                  await this.callback.call(this)
                  for (const StartVvehiclesScript2 of scriptStarted) {
                    await StartVvehiclesScript2.call(this)
                  }
                }, this.delay)
                break
              }
              case 'timeout': {
                if (this.active) {
                  this.threadId = setTimeout(async () => {
                    await this.callback.call(this)
                    for (const StartVehiclesScript3 of scriptStarted) {
                      await StartVehiclesScript3.call(this)
                    }
                  }, this.delay)
                }
                break
            ...
            const afterStartedVehicles = this.hooks.get('afterStart')
            try {
              for (const callStartedSuccessfully of afterStartedVehicles) {
                await callStartedSuccessfully.call(this)
              }
            } catch (afterStartedHookError) {
              console.log('Error while calling after-start hook ' + afterStartedHookError.message)
            }
          }
          async ['stop']() {
            if (!this.active) {
            ...
            const preStopAfterStartError = this.hooks.get('preStop')
            try {
              for (const abortImmediately of preStopAfterStartError) {
                if (!this.aborted) {
                  await abortImmediately.call(this)
                }
              }
            } catch (hookErrorAfterStartError) {
              ; (this.aborted = true),
                console.log('Error while calling pre-stop hook ' + hookErrorAfterStartError.message)
            }
            this.active = false
            switch (this.mode) {
              case 'tick': {
            ...
            if (this.aborted) {
              try {
                const stoppedFoundError = this.hooks.get('stopAborted')
                for (const abortVehicleScript of stoppedFoundError) {
                  await abortVehicleScript.call(this)
                }
              } catch (stopFoundError) {
                console.log('Error while calling stop-aborted hook ' + stopFoundError.message)
              }
            }
            const afterStopVehicles = this.hooks.get('afterStop')
            try {
              for (const callAfterStop of afterStopVehicles) {
                await callAfterStop.call(this)
              }
            } catch (errorFoundSendLog) {
              console.log('Error while calling after-stop hook ' + errorFoundSendLog.message)
            }
          }
          ['abort']() {
            this.aborted = true
      ...
      957: function (_0x410d15, _0xec029f, _0x35983a) {
        ...
        RPC.register('SetVehicleNumberPlateText', (_0x16bd6b, _0x35c9fa) => {
          const _0x495acf = NetworkGetEntityFromNetworkId(_0x16bd6b)
          if (DoesEntityExist(_0x495acf)) {
            return SetVehicleNumberPlateText(_0x495acf, _0x35c9fa)
          }
        })
        RPC.register('GetVehicleMod', (_0x4f0ca6, _0x58f1cc) => {
        ...
        RPC.register('GetVehicleMods', (_0x14862d) => {
          const _0x43854b = NetworkGetEntityFromNetworkId(_0x14862d)
          if (DoesEntityExist(_0x43854b)) {
            return _0x79d560.GetMods(_0x43854b)
          }
        })
        RPC.register('SetVehicleMod', (_0x5496f8, _0x35d294, _0x43422b) => {
        ...
        RPC.register('SetVehicleMods', (_0x265987, _0x2ac3fe) => {
        ...
        RPC.register('GetVehicleColor', (_0x36fbd9, _0x36f210) => {
        ...
        RPC.register('SetVehicleColor', (_0x5f486b, _0x16702d, _0x428d81) => {
        ...
        RPC.register('SetVehicleColors', (_0x4206bd, _0x54472a) => {
        ...
        RPC.register('GetVehicleAdditional', (_0x26c508, _0x4f3591) => {
        ...
        RPC.register(
          'SetVehicleAdditional',
          (_0x1fb580, _0x1bdfc5, _0x3a551a) => {
        ...
        RPC.register('GetVehicleAppearance', (_0x5be0ed) => {
        ...
        RPC.register('SetVehicleAppearance', (_0x322cbb, _0x1ad178) => {
        ...
        RPC.register('FetchVehicleDamage', (_0x57a0c0) => {
        ...
        RPC.register('RestoreVehicleDamage', (_0x33c9ee, _0x313a5d) => {
        ...
        RPC.register('GetVehicleClassFromName', (_0x2d49ce) => {
          const _0xef0947 =
            typeof _0x2d49ce === 'string' ? GetHashKey(_0x2d49ce) : _0x2d49ce
          return GetVehicleClassFromName(_0xef0947)
        })
        RPC.register('GetVehicleName', (_0x1655e4) => {
          const _0x6c191d =
            typeof _0x1655e4 === 'string' ? GetHashKey(_0x1655e4) : _0x1655e4
          return GetLabelText(GetDisplayNameFromVehicleModel(_0x6c191d))
        })
        onNet('arp:vehicles:setKeys', (_0x56bae3) => {
          if (!_0x56bae3) {
            return
          }
        ...
        onNet('arp:vehicles:removeSharedKeys', (_0x140996) => {
        ...
        onNet('vehicle:keys:give', async (_0x52f1da) => {
          ...
          if (
            ...
            if (GetVehiclePedIsIn(_0x49cc53, false) !== 0) {
              ...
              _0x31b286 = Number(
                _0x35983a.g.exports['arp-targetinteract'].GetCurrentEntity()
              )
            }
          } else {
          ...
          if (IsPedInAnyVehicle(_0x49cc53, false)) {
            ...
            for (
              ...
              if (_0x4ebc66 && _0x4ebc66 !== _0x49cc53) {
                RPC.execute(
                  'arp:vehicles:giveKey',
                  GetPlayerServerId(NetworkGetPlayerIndexFromPed(_0x4ebc66)),
                  GetVehicleNumberPlateText(_0x52f9f7)
                )
              }
            }
          } else {
            const [_0x6a3613, _0x29780c] =
              _0x35983a.g.exports['arp-vehicles'].GetClosestPlayer()
            if (Number(_0x29780c) !== -1 && Number(_0x29780c) < 5) {
              let _0x1c054b = await RPC.execute(
                'arp:vehicles:giveKey',
                GetPlayerServerId(_0x6a3613),
                GetVehicleNumberPlateText(_0x31b286)
              )
              if (!_0x1c054b) {
        ...
        onNet('vehicle:keys:addNew', (_0x127d05) => {
          const _0x538e87 = NetworkGetNetworkIdFromEntity(_0x127d05)
          if (DoesEntityExist(_0x127d05) && _0x538e87 !== 0) {
            const _0x3d7239 = GetEntityModel(_0x127d05)
            emitNet('arp:vehicles:gotKeys', _0x538e87, _0x3d7239)
          }
          SetVehRadioStation(Number(_0x127d05), 'OFF')
          SetVehicleDoorsLocked(Number(_0x127d05), 1)
        })
        ...
        onNet('vehicle:refuel:showMenu', (_0x192057, _0x540ffe, _0x41ba60) => {
          const _0x1c5ff2 = GetVehicleFuelLevel(_0x540ffe)
          ...
          _0x35983a.g.exports['arp-interface'].showContextMenu(_0x15fa55)
        })
            ...
            if (_0x221823) {
              ...
              if (!_0x221823.startsWith('3')) {
                return emit(
                  ...
                  'DISPATCH',
                  2,
                  'The plate does match the VIN! (' + _0x4031a9 + ')',
                  'feed',
                  false
                )
              }
        ...
        onNet('vehicle:addFakePlate', async (_0x44a09f, _0x1dd7be) => {
          ...
          if (!_0x297f16.startsWith('3')) {
            return emit(
              'DoLongHudText',
              "Can't apply fake plates to local cars.",
              2
            )
          }
        ...
        onNet('arp:vehicles:sellPhone', (_0x20d4c, _0x2423fa, _0x249d07) => {
        ...
        onNet(
          ...
          (_0x1ed5dd, _0xa3682c, _0x4cbdc5, _0x2765f6, _0x153b40) => {
            ...
            if (_0x1ed5dd === _0x5ba5c3) {
              const _0x9344a5 = _0x2765f6.toLocaleString('en-US', {
                ...
                _0x477852 = _0x35983a.g.exports[
                  'arp-newphone'
                ].DoPhoneConfirmation(30, 'Purchase Vehicle', _0x24f1b8, 'car')
              if (_0x477852) {
                emitNet(
          ...
          if (
            ...
            if (_0x36f7a8) {
              if (_0x36f7a8.startsWith('3')) {
                emitNet('arp:vehicles:addNitro', _0x2f8f0d, _0x459c4f)
              } else {
                emit(
                  'DoLongHudText',
                  'You can only put nos inside a personal vehicle.',
                  2
                )
              }
            }
        ...
        on('vehicle:addHarness', (_0x57d80e) => {
          ...
          if (_0xa13c3c) {
            if (_0xa13c3c.startsWith('3')) {
              emitNet('arp:vehicles:addHarness', _0x35eb4c, _0x57d80e)
            } else {
              emit(
                'DoLongHudText',
                'You can only put a harness inside a personal vehicle.',
                2
              )
            }
          }
        ...
        onNet('vehicle:refuel:showMenu', async (_0x45e91f, _0x47de13) => {
          ...
          _0x35983a.g.exports['arp-interface'].showContextMenu([
            {
              title: 'Gas Station',
              description:
                'The total cost is going to be $' +
            ...
            if (_0x4d31a6 === -1 || _0x4d31a6 === 0) {
              ...
              _0xf5375d = setTimeout(() => {
                const _0x3af534 = PlayerPedId(),
                  ...
                  _0x5643e1 =
                    GetVehicleDoorAngleRatio(_0x3e0ca5, _0x4d31a6 + 1) > 0.1,
        ...
        onNet('baseevents:leftVehicle', (_0x26a7a4, _0x27fc98) => {
          ...
          if (GetEntityModel(_0x26a7a4) == GetHashKey('taxi')) {
        ...
        onNet(
          'baseevents:vehicleChangedSeat',
          (_0x1f5303, _0x5bbd57, _0x2405cf) => {
            _0x41654d.UpdateCurrentVehicle()
              ; (0, _0x41d541.SetHarness)(false)
              ; (0, _0x41d541.SetSeatBelt)(false)
        ...
        RPC.register('arp:vehicles:getWaterHeight', () => {
          const [_0x3e5361, _0x522fcd, _0x56576d] = GetEntityCoords(
            PlayerPedId(),
            false
          )
        ...
        on(
          'arp:vehicles:examineVehicle',
          async (_0x2a7968, _0x21d5c3, _0x439e09) => {
            const _0x1953ee =
              _0x35983a.g.exports['arp-business'].IsEmployedAt('hayes_autos')
            if (
              !_0x1953ee ||
              (!_0x1953ee &&
                !_0x35983a.g.exports['arp-inventory'].hasEnoughOfItem(
                  'advrepairkit',
                  1,
                  false
                ))
              ...
              return emit(
                'DoLongHudText',
                'I cannot examine the vehicle right now.',
                2
              )
            }
        ...
        on('arp-vehicles:client:refillNoS', () => {
          return (0, _0x40670d.RefillNOSCan)(100)
        })
        onNet('arp-vehicles:giveNitrous', () => {
          emit(
            'player:receiveItem',
            'nitrous',
            1,
        ...
        RegisterCommand(
          ...
          () => {
            ...
            console.log(
              'Class: ' +
              (0, _0x4a8133.GetVehicleRatingClass)(_0x43e739) +
              ' | Rating: ' +
              (0, _0x4a8133.GetVehicleRatingNumber)(_0x43e739)
            )
          },
          false
        )
      ...
      457: (_0x3da443, _0x501dfb, _0x28ec67) => {
        ...
        onNet(
          'RunUseItem',
          async (_0x357d8, _0x31cf1b, _0x7853a9, _0x2a6e27, _0x25cb35) => {
            if (!_0x5e4515.has(_0x357d8)) {
              return
            }
            const _0x2b93f9 =
              _0x28ec67.g.exports['arp-inventory'].hasEnoughInfo(_0x31cf1b),
      ...
      784: (_0x580ee1, _0x1d9e2a, _0x12307e) => {
        ...
        async function _0x5c2088(_0x58c3aa, _0x1ac716) {
          const _0x50c979 = _0x58c3aa
            ? _0x58c3aa
            : _0x12307e.g.exports['arp-target'].GetCurrentEntity()
          if (!_0x50c979) {
            return
          }
          ...
          if (_0x2f3e25 === 15 || _0x2f3e25 === 16) {
            return emit(
              'DoLongHudText',
              'Repair kit ineffective for this vehicle.',
              2
            )
          } else {
            if (
              _0x12307e.g.exports['arp-flags'].HasVehicleFlag(
                _0x50c979,
                'isScrapVehicle'
              )
            ) {
          ...
          const _0x5a3533 = (0, _0x580cdc.unkFunc41)(
            _0x50c979,
            2,
            'bonnet',
            _0x3e60cd
          ...
          const _0x20a4b6 = await (0, _0x54e6f7.PlayAnimation)(
            PlayerPedId(),
            _0x58c3aa,
            'repairkit:engine'
          )
          ...
          emit(
            ...
            _0x1ac716 ? 'advrepairkit' : 'repairkit',
            1
          )
        }
        _0x1d9e2a.UseVehicleRepairKit = _0x5c2088
        async function _0x377aea(
          _0x41bb14,
          _0x4c85e9,
          _0x404f3b,
          _0x1af1ee = 10
          ...
          if (!_0x3abf0e) {
            return emit(
              'DoLongHudText',
              "This vehicle doesn't need to be repaired.",
              2
            )
          }
          ...
          let _0x5c2235 = (0, _0x15d4d0.GetAnimationSettings)(
            'degradation:' + _0x4c85e9
          ),
          ...
          if (!_0x35e6b2 || _0x46835e) {
            ...
            if (_0x1db9ae > _0x5c2235.data.distance) {
              return emit(
                'DoLongHudText',
                'Get closer to the area that needs to be repaired.',
                2
              )
            }
          }
          await (0, _0x580cdc.TurnPedCoords)(PlayerPedId(), _0x46a49e)
          const _0x255f00 = await RPC.execute(
            'arp:vehicles:degradation:requestRepair',
            _0x1df2f2,
            _0x4c85e9,
            _0x1af1ee
          )
          ...
          return (
            RPC.execute(
              'arp:vehicles:degradation:doRepair',
              _0x1df2f2,
              _0x4c85e9,
              _0x1af1ee,
              _0x255f00
        ...
        async function _0x1626a5(_0x57cb05) {
          ...
          if (
            ...
            return emit(
              'DoLongHudText',
              'The vehicle tire is beyond repair.',
              2
            )
          }
          const _0x2d5bff = (0, _0x15d4d0.GetAnimationSettings)(
            'degradation:tyres'
          ),
        ...
        async function _0x69e8c6(_0xc3c9f0, _0x2ede0f, _0x2a8d99, _0x36cc5c) {
          ...
          if (_0x36cc5c !== true) {
            return RPC.execute(
              'arp-vehicles:applyIllegalMod',
              NetworkGetNetworkIdFromEntity(_0x1654a7),
              _0x2ede0f
            )
          }
          switch (_0x2ede0f) {
          ...
          const [_0x2bd0d0, _0x33c7da, _0x3d2bda] = GetEntityCoords(
            ...
            _0x2b3732 = new Promise(async (_0x4748ee) => {
              for (const _0x27c11d of _0x49a828) {
                ...
                const [_0x47af2f] = await RPC.execute(
                  'IsEmployedAtBusiness',
                  _0x4d7c58
                )
                if (_0x47af2f) {
        ...
        async function _0x5a866d() {
          const _0x14d08b = async (
            ...
            if (!_0x269f57) {
              return emit(
                'DoLongHudText',
                "You're not prepared to do repairs here.",
                2
              )
            }
            if (
              !_0x433d21.g.exports['arp-inventory'].hasEnoughOfItem(
                'repairtoolkit',
                1
              )
            ) {
              return emit(
                'DoLongHudText',
                'You need the proper tools to repair this.',
                2
              )
            }
            const _0x5824b3 =
              _0x433d21.g.exports['arp-targetinteract'].GetCurrentEntity()
            if (!_0x5824b3) {
              return
            }
            let _0x4336c3 = 1
            ...
            const _0x46356d = await (0, _0x1ba9ae.FixVehicleDegredation)(
              _0x5824b3,
              _0x1babe3,
              _0x14106a,
              _0x85e30d * _0x4336c3
            ...
            if (_0x1babe3 === 'engine') {
              ...
              RPC.execute(
                'arp-vehicles:damage:saveDamage',
                NetworkGetNetworkIdFromEntity(_0x5824b3)
              )
            } else {
              _0x1babe3 === 'body' &&
            ...
            emit(
              'arp-mechanics:client:vehiclePartApplied',
              _0x4336c3,
              NetworkGetNetworkIdFromEntity(_0x5824b3),
              _0x1babe3
            )
            ...
            const _0x12f862 = 'carpolish_' + _0xe410f0.tier
              ; (0, _0x3590c9.RegisterItemCallback)(
                ...
                async (_0x3e1e83) => {
                  ...
                  await (0, _0xa86721.ApplyCarPolish)(
                    _0xdacfb4,
                    _0x3e1e83,
                    _0xe410f0.days
                  )
          ...
          _0xde01ec.forEach((_0x223ab1) => {
            ; (0, _0x3590c9.RegisterItemCallback)(
              _0x223ab1.name,
              async (_0x11bbe8, _0x4a7530, _0x1e1042, _0x36d340) => {
                if (_0x36d340 < 50) {
                  return emit(
                    'DoLongHudText',
                    'Part too beaten-up to be installed.',
                    2
                  )
                }
                const _0xcc7243 =
                ...
                if (
                  ...
                  return emit(
                    'DoLongHudText',
                    "You don't have the required tools to perform this action.",
                    2
                  )
                }
                ...
                if (
                  ...
                  return emit(
                    'DoLongHudText',
                    "Doesn't seem like I can apply that to this vehicle.",
                    2
                  )
                }
      ...
      302: (_0x5c83fe, _0x163108, _0x347b27) => {
        ...
        function _0x536068(_0x504771, _0x4d3c75, _0x133345) {
          switch (_0x4d3c75) {
            case 'body': {
              return SetVehicleBodyHealth(_0x504771, _0x133345)
            }
            case 'engine': {
              return SetVehicleEngineHealth(_0x504771, _0x133345)
            }
            case 'dirt': {
              return SetVehicleDirtLevel(_0x504771, _0x133345)
            }
            case 'windows': {
              return _0x133345.forEach((_0x3e67f7) => {
                if (_0x3e67f7.broken) {
                  SmashVehicleWindow(_0x504771, _0x3e67f7.index)
                }
              })
            }
            case 'doors': {
              return _0x133345.forEach((_0x5750e0) => {
                _0x5750e0.broken &&
                  SetVehicleDoorBroken(_0x504771, _0x5750e0.index, true)
              })
            }
            case 'wheels': {
              return _0x133345.forEach((_0x556d08) => {
                if (_0x556d08.health < 50) {
                  SetVehicleTyreBurst(_0x504771, _0x556d08.index, true, 1000)
                } else {
                  if (_0x556d08.health < 100) {
                    SetVehicleTyreBurst(_0x504771, _0x556d08.index, false, 1)
                  } else {
      ...
      628: (_0x20c7ed, _0x323133, _0x1486ff) => {
        ...
        async function _0x471053(_0x33fdbf) {
          if (_0x33fdbf) {
            const _0x41242a = await RPC.execute(
              'arp:vehicles:getLicensePlate',
              _0x33fdbf
            )
            return _0x41242a
          }
        ...
        async function _0x3d4d85(_0x249b2b, _0x554cc5) {
          ...
          if (_0x1700a3 === 100) {
            const _0x336dd1 = NetworkGetNetworkIdFromEntity(_0x249b2b),
              _0x35afd2 = await RPC.execute(
                'arp:vehicles:setFakeLicensePlate',
                _0x336dd1,
                _0x554cc5
              )
      ...
      130: (_0x4f3319, _0x339e48, _0x5c5457) => {
        ...
        function _0x12ce0e(_0x39d255) {
          const _0x124b31 = { _0x585a14: _0x5875e1(_0x39d255, _0x585a14) }
          for (const _0x585a14 in _0x566745.Mods) {
            if (isNaN(Number(_0x585a14))) {
            }
          }
          return _0x124b31
        }
        ...
        function _0x181a6a(_0x51320a, _0x5dbfd9, _0x4f3d89) {
          const _0x1622e9 = Number(_0x566745.Mods[_0x5dbfd9]),
            _0x36cf88 =
              (_0x1622e9 === 23 || _0x1622e9 === 24) && _0x4f3d89 !== -1
          if (!isNaN(_0x1622e9)) {
      ...
      908: function (_0xe21590, _0x5d0117, _0x129452) {
        ...
        async function _0x1e3a28() {
          await (0, _0x12c4d5.IsConfigReady)()
          const _0x479d18 = (0, _0x12c4d5.GetModuleConfig)(
            'arp-vehicles:garages'
          )
        ...
        _0x5d0117.InitGarages = _0x1e3a28
        ...
        async function _0x127481(_0x2a624b, _0x1a9f61) {
          const _0x585a5b = _0x2a624b
            ...
            _0x33f501 = GetVehicleNumberPlateText(_0x1a9f61)
          if (_0x585a5b && _0x33f501) {
            const _0x50b529 = await _0x5c947a(_0x2a624b),
              _0x4c04b7 = _0x1a9f61
                ? _0x50b529.find((_0x59dcdf) => _0x59dcdf.plate === _0x33f501)
                : false
            return _0x4c04b7 || _0x50b529.length + 1 < _0x585a5b.parking_limit
          }
        }
        _0x5d0117.HasGarageSpace = _0x127481
        async function _0xa8a77f(_0x29584e) {
          const _0x456ed6 = _0x29584e
            ? _0x302582(_0x29584e)
            : _0x302582(_0x5d0117.currentGarage)
          if (!_0x456ed6) {
            return false
          ...
          switch (_0x456ed6.type) {
            case 'housing': {
              _0x590524 = await new Promise((_0x27d707) => {
                ...
                emit(
                  'arp:vehicles:hasHouseGarageAccess',
                  _0x456ed6.garage_id,
                  _0x27d707
                )
              })
            ...
            case 'business': {
              ...
              _0x590524 = await new Promise((_0x3376ce) => {
                setTimeout(() => _0x3376ce(false), 5000),
                  emit(
                    'arp:vehicles:hasBusinessGarageAccess',
                    _0x456ed6.garage_id,
                    _0x456ed6.business_id,
                    _0x3376ce
                  )
              })
              break
            ...
            case 'job': {
              _0x590524 = await new Promise((_0x26a47a) => {
                setTimeout(() => _0x26a47a(false), 5000),
                  emit(
                    'arp:vehicles:hasJobGarageAccess',
                    _0x456ed6.garage_id,
                    _0x26a47a
                  )
              })
            ...
            case 'state': {
              _0x590524 = await new Promise((_0x110253) => {
                ...
                emit(
                  'arp:vehicles:hasStateGarageAccess',
                  _0x456ed6.garage_id,
                  _0x110253
                )
              })
        ...
        function _0xbfb792(_0x1f4918, _0x20d8b9 = false, _0x42a0a5) {
          ...
          if (_0x492e00) {
            const [_0x5c84aa, _0x11435c, _0x3a4fea] = GetEntityCoords(
              _0x1f4918,
              false
            )
            for (const _0x353cc6 of _0x492e00.parking_spots) {
              const _0x5afdce = GetDistanceBetweenCoords(
                ...
                _0x5a4405 = _0x42a0a5 ? _0x42a0a5 : _0x353cc6.distance
                ; (!_0x20d8b9 || _0x156792) &&
                  _0x5afdce <= _0x5a4405 &&
        ...
        async function _0x574841(_0x2ac7c5, _0x30d119, _0x2bf8b7 = false) {
          ...
          if (_0x2ac7c5) {
            const [_0x26f755, _0x1f7d2b] = _0xbfb792(
              PlayerPedId(),
              _0x2bf8b7,
              _0x30d119
            )
        ...
        async function _0x47b2b4(_0x2d1d46) {
          ...
          const _0x9160bd = await RPC.execute(
            'arp:vehicles:storeVehicle',
            NetworkGetNetworkIdFromEntity(_0x2d1d46),
            _0x5d0117.currentGarage
          )
          if (!_0x9160bd) {
        ...
        async function _0x5c947a(_0x193f50) {
          if (
            _0x5d0117.garageVehicleCache.has(_0x193f50) &&
            !_0x5d0117.garageVehicleCache.isExpired(_0x193f50)
          ) {
            return _0x5d0117.garageVehicleCache.get(_0x193f50)
          }
          const _0x2d8840 = await RPC.execute(
            'arp:vehicles:getVehicles',
            _0x193f50
          )
          if (_0x2d8840) {
            return (
              _0x5d0117.garageVehicleCache.set(_0x193f50, _0x2d8840, 120000),
              _0x5d0117.garageVehicleCache.get(_0x193f50)
            )
          }
          return false
        }
        ...
        async function _0x26ebfb(_0x129bca, _0x542d7b, _0x4eb9f) {
          ...
          if (_0x402e5a) {
            const _0x3dad18 = GetHashKey(_0x402e5a.model),
              { coords: _0x19de1e, heading: _0x11e873 } =
                _0x5d0117.currentParkingSpot
        ...
        async function _0x2e8fea(_0x1fb53e, _0x4cd4cc, _0x21553c) {
          const { heading: _0x33a6ee, coords: _0x498c49 } =
            _0x5d0117.currentParkingSpot,
            _0xf8c0f6 = await RPC.execute(
        ...
        async function _0x331a62(_0x5dd35b) {
          const _0xbc61ad = await RPC.execute(
        ...
        on('arp-polyzone:enter', async (_0xc3c98a) => {
          if (!_0x5d0117.garages.has(_0xc3c98a)) {
            return
          }
          _0x5d0117.currentGarage = _0xc3c98a
        })
        on('arp-polyzone:exit', (_0x121383) => {
      ...
      710: (_0x3fe3be, _0x5ca661, _0x4539c3) => {
        ...
        onNet('arp:vehicles:giveKeys', async () => {
          const _0x2ad5da = _0x4539c3.g.exports.isPed.isPed('cid'),
            _0x5e9183 = await RPC.execute(
        ...
        function _0x4ae268(_0x1a3d72, _0x19a40c) {
          ...
          if (_0x1dc56c && _0x5ca661.Keys.has(_0x1dc56c)) {
            RPC.execute('arp:vehicles:giveKey', _0x1dc56c, _0x19a40c).then(
              (_0x2895e1) => {
                if (_0x2895e1) {
                  emit(
                    'DoLongHudText',
                    'You just gave the keys of your vehicle!',
                    1
                  )
                }
              }
      ...
      474: (_0x29aec7, _0x5a2cc3, _0xd4438) => {
        ...
        function _0x190e18(_0xef347e) {
          const _0x47aeb2 = (0, _0x3c22f5.GetVehicleMetadata)(
            _0xef347e,
            'carPolish'
          )
        ...
        function _0x1d3a54(_0x5d2ac9) {
          const _0x50a573 = (0, _0x3c22f5.GetVehicleMetadata)(
            _0x5d2ac9,
            'carPolish'
          )
        ...
        async function _0x1169d4(_0x1748a6, _0x25dce6, _0x191c41) {
          ...
          if (_0x52fd46 == 100) {
            ...
            emitNet('arp:vehicles:addCarPolish', _0x1748a6, _0x191c41)
        ...
        _0x12c011.DriverThread.addHook('afterStop', function () {
          if (
            ...
            emitNet('arp:vehicles:removeCarPolish', this.data.netId)
          }
        })
      },
      256: (_0x133edd, degradationData, interfaceExportsSep) => {
        Object.defineProperty(degradationData, '__esModule', { value: true })
        degradationData.HasVehicleClass =
          degradationData.DoRandomTyreDamage =
          degradationData.SaveDegradation =
          degradationData.DoRandomDegradation =
          degradationData.ShowVehicleDegradation =
          degradationData.GetDefaultDegradation =
          degradationData.GetVehicleDegradation =
          degradationData.InitDamage =
          void 0
        const vehicleGetRndDegAmt = interfaceExportsSep(615),
          _0x3cd642 = interfaceExportsSep(343),
          _0x160793 = interfaceExportsSep(348),
          _0x3ad81e = interfaceExportsSep(450),
          _0x11aa22 = interfaceExportsSep(396),
          _0x4fd263 = interfaceExportsSep(141),
          getVehicleDegradation = new Map()
        async function _0x58494d() { }
        degradationData.InitDamage = _0x58494d
        ...
        degradationData.GetVehicleDegradation = _0x255e45
        interfaceExportsSep.g.exports('GetVehicleDegradation', _0x255e45)
        function _0x253f9a() {
          return {
            axle: 100,
            brakes: 100,
        ...
        degradationData.GetDefaultDegradation = _0x253f9a
        function vehicleDegradeInfo(_0x3a9400, vehicleRating) {
          const _0x2986a6 = _0x255e45(_0x3a9400),
            mileage = (0, _0x4fd263.GetVehicleMileage)(_0x3a9400)
          if (!_0x2986a6) {
            return
          }
          const vehicleInformation = (0, _0x3cd642.GetVehicleRating)(_0x3a9400)
          if (!vehicleInformation) {
            return
          }
          let diagnosticsDatah = []
          for (const [_0x192808, _0x35cfa2] of Object.entries(_0x2986a6)) {
            ...
            diagnosticsDatah.push({
              title: (0, _0x3cd642.GetLocale)(_0x192808),
              description: _0x50a31a,
            })
          }
          diagnosticsDatah = diagnosticsDatah.sort((_0x3af46d, _0x22b5aa) => {
            return _0x3af46d.title.localeCompare(_0x22b5aa.title)
          })
          interfaceExportsSep.g.exports['arp-interface'].showContextMenu([
            {
              ...
              description:
                ...
                ' | Rating: ' +
                (vehicleRating ? vehicleInformation.power : 'Unknown') +
                ' | Mileage: ' +
                Number(mileage).toFixed(1),
            },
            {
              title: 'Vehicle Diagnostics',
              description: '',
              children: diagnosticsDatah,
            },
          ])
        }
        degradationData.ShowVehicleDegradation = vehicleDegradeInfo
        interfaceExportsSep.g.exports('ShowVehicleDegradation', vehicleDegradeInfo)
        function degradeVehicle(VehicleDegrading, degradeAmt = 2, SHRUG = false) {
          if (!SHRUG && (0, vehicleGetRndDegAmt.GetRandom)(100) > 20) {
            return
          }
          if (!getVehicleDegradation.has(VehicleDegrading)) {
            getVehicleDegradation.set(VehicleDegrading, _0x255e45(VehicleDegrading))
          }
          const degradeLvls = getVehicleDegradation.get(VehicleDegrading)
          for (const [vehicleDegraded] of Object.entries(degradeLvls)) {
            degradeLvls[vehicleDegraded] = +(degradeLvls[vehicleDegraded] - (0, vehicleGetRndDegAmt.GetRandom)(degradeAmt)).toFixed(2)
          }
          _0x3f9bb3(VehicleDegrading)
        }
        degradationData.DoRandomDegradation = degradeVehicle
        async function vehDegradeLvl(VehicleSelected) {
          const curVehicleDegradeLvl = getVehicleDegradation.get(VehicleSelected)
          if (!curVehicleDegradeLvl) {
            return
          }
          const vehicleSeleectedToDegrade = NetworkGetNetworkIdFromEntity(VehicleSelected),
            AwaitRPCDegrade = await RPC.execute('arp:vehicles:addDegradation', vehicleSeleectedToDegrade, curVehicleDegradeLvl)
            AwaitRPCDegrade && getVehicleDegradation.delete(VehicleSelected)
          }
        degradationData.SaveDegradation = vehDegradeLvl
        function TyreDegrade(curVeh, wheelHlthLevel, degAmtWheel, degradeWheelAmount) {
          const wheelHealth = GetVehicleWheelHealth(curVeh, wheelHlthLevel),
            degradedWheelHealthAmt2 = degradeWheelAmount
              ? (0, vehicleGetRndDegAmt.GetRandom)(degAmtWheel, degradeWheelAmount)
              : (0, vehicleGetRndDegAmt.GetRandom)(degAmtWheel),
            newWheelHealth = wheelHealth - degradedWheelHealthAmt2
          return (
            SetVehicleWheelHealth(curVeh, wheelHlthLevel, newWheelHealth),
            newWheelHealth < 300 &&
            !IsVehicleTyreBurst(curVeh, wheelHlthLevel, false) &&
            SetVehicleTyreBurst(curVeh, wheelHlthLevel, true, 100),
            newWheelHealth
          )}
        degradationData.DoRandomTyreDamage = TyreDegrade
        function getVehClass(vehicleIdentity) {
          return (vehicleIdentity === 13 || vehicleIdentity === 14 || vehicleIdentity === 15 || vehicleIdentity === 16)
        }
        degradationData.HasVehicleClass = getVehClass
        let myPlayerPedVehice = 0,
          _0x398771 = false
        const _0xda90ef = {
          ...
          _0x4210d0 = (_0x5921aa) => {
            ...
            if (_0x1b38f4.brakes < 60 && (0, vehicleGetRndDegAmt.GetRandom)(1, 4) > 3) {
              SetVehicleBrakeLights(_0x5921aa, true)
            }
            if (_0x1b38f4.clutch < 60 && (0, vehicleGetRndDegAmt.GetRandom)(1, 4) > 3) {
            ...
            _0x1b38f4.electronics < 60 &&
              (SetVehicleLightMultiplier(
                _0x5921aa,
                (0, vehicleGetRndDegAmt.GetRandom)(0, 10) / 10
              ),
                SetVehicleIndicatorLights(
                  _0x5921aa,
                  (0, vehicleGetRndDegAmt.GetRandom)(0, 1),
                  true
                ))
            if (
              _0x1b38f4.electronics < 30 &&
              (0, vehicleGetRndDegAmt.GetRandom)(1, 4) > 3
            ) {
            ...
            if (
              ...
              (0, vehicleGetRndDegAmt.GetRandom)(1, 20) > 19
            ) {
              SetVehiclePetrolTankHealth(_0x5921aa, 500)
            }
            if (_0x1b38f4.radiator < 60 && (0, vehicleGetRndDegAmt.GetRandom)(1, 4) > 3) {
              SetVehicleEngineHealth(
                _0x5921aa,
                GetVehicleEngineHealth(_0x5921aa) - 50
              )
              if (_0x1b38f4.body < 50 && (0, vehicleGetRndDegAmt.GetRandom)(1, 20) > 19) {
                SetVehicleDoorBroken(
                  _0x5921aa,
                  (0, vehicleGetRndDegAmt.GetRandom)(0, 5),
                  false
                )
              }
              if (
        ...
        _0x160793.DriverThread.addHook('active', function () {
          if (++this.data.damageTick > 30) {
            ...
            for (let _0x15a6f1 = 0; _0x15a6f1 < _0x2c616d; _0x15a6f1 += 1) {
              TyreDegrade(this.data.vehicle, _0x15a6f1, _0x2a4fd3 + _0x5beb0f)
            }
          } else {
        ...
        _0x160793.DriverThread.addHook('preStop', function () {
          if (getVehClass(this.data.vehicleClass)) {
            return
          }
          vehDegradeLvl(this.data.vehicle)
        })
      ...
      17: (_0x575311, GetRefuelingData, _0x4cc917) => {
        Object.defineProperty(GetRefuelingData, '__esModule', { value: true })
        GetRefuelingData.RefuelJerryCan =
          GetRefuelingData.GetJerryCanFuelLevel =
          GetRefuelingData.RefuelVehicle =
          GetRefuelingData.GetVehicleRefuelCost =
          GetRefuelingData.IsDoorOpen =
          GetRefuelingData.EmitLowFuelSound =
          GetRefuelingData.SetVehicleFuel =
          GetRefuelingData.CurrentFuel =
          GetRefuelingData.GetVehicleFuel =
          GetRefuelingData.InitFuel =
          void 0
        const playerPlayJerryCanAnim = _0x4cc917(997),
        ...
        GetRefuelingData.InitFuel = _0x1e4cdf
        const _0x15e962 = GetHashKey('newsmav')
        function _0x5d5922(_0x1a3984) {
          const _0x4c662f = (0, _0x139fc5.GetVehicleMetadata)(_0x1a3984, 'fuel')
          if (_0x4c662f) {
            return _0x4c662f
          } else {
            return 50
        ...
        GetRefuelingData.GetVehicleFuel = _0x5d5922
        function _0x543b3a() {
          return (
            (_0x139fc5.CurrentVehicle && _0x5d5922(_0x139fc5.CurrentVehicle)) ||
            50
          )
        }
        GetRefuelingData.CurrentFuel = _0x543b3a
        function _0x13b9ac(_0x5bfb8f, _0x50f8f3) {
          const _0x2c8d1e = Math.floor(_0x50f8f3)
          if (_0x2c8d1e > 0) {
            emitNet(
              'arp:vehicles:reduceFuel',
              NetworkGetNetworkIdFromEntity(_0x5bfb8f),
              _0x2c8d1e
            )
          }
        }
        GetRefuelingData.SetVehicleFuel = _0x13b9ac
        ...
        _0x45ba32.DriverThread.addHook('active', function () {
          const _0x4f628f =
            this.data.vehicleHealth / _0x2204d7.fuelHealthModifier
          let _0x23f56f = Math.max(2 - _0x4f628f, 1)
          if (this.data.isHelicopter && !this.data.isNewsHelicopter) {
            _0x23f56f = _0x2204d7.heliFuelDrainRate - _0x4f628f
          }
          let _0x1b9e8c = this.data.fuel
          _0x1b9e8c -=
            (_0x2204d7.fuelDrainBase * (this.data.speed ^ 2) * _0x23f56f) / 1000
        ...
        async function _0x49d508(
          ...
          const { taxLevel: _0x2f5f3e, fuelPrice: _0x2756f4 } =
            await RPC.execute('arp:vehicles:getFuelPrice', 1),
        ...
        GetRefuelingData.GetVehicleRefuelCost = _0x49d508
        async function _0x36d9c7(
          targetVeh,
          refuelPrice,
          refueling = false,
          canRefuel = false,
          ...
          const _0x5c8eae = PlayerPedId(),
            curVehicleFuel = _0x5d5922(targetVeh) || 0
          let _0x1e4ea9 = 100 - curVehicleFuel,
            _0x26f983 = _0x1e4ea9 * 500
          if (canRefuel) {
            _0x1e4ea9 =
              (((GetAmmoInPedWeapon(_0x5c8eae, 883325847) * 100) / 4500) * 35) /
              100
            _0x26f983 = Math.floor(_0x1e4ea9 * 2 * 1000)
          }
          if (IsThisModelAHeli(GetEntityModel(targetVeh))) {
            _0x26f983 *= 2
          }
          TaskTurnPedToFaceEntity(_0x5c8eae, targetVeh, -1)
          const _0x4756b6 = new playerPlayJerryCanAnim.AnimationTask(
            PlayerPedId(),
            'normal',
            'Refueling',
            _0x26f983,
            ...
            _0x42e541 = await _0x4756b6.start((_0x3537bb) => {
              const _0x1c865f = setInterval(() => {
                ...
                if (
                  IsVehicleEngineOn(targetVeh) &&
                  (0, _0x35e406.GetRandom)(100) > 98
                ) {
                  NetworkExplodeVehicle(targetVeh, true, false, false)
                  _0x4756b6.abort()
                }
              }, 2000)
            }),
            _0x4a480f = _0x4cc917.g.exports.isPed.isPed('mycash')
          if (_0x4a480f < refuelPrice) {
            emit(
              'DoLongHudText',
              "You can't afford it, you're missing $" + (refuelPrice - _0x4a480f),
              1,
              12000
            )
            return
          }
          const fuelAddAmount = (_0x42e541 * _0x1e4ea9) / 100
          if (canRefuel) {
            const _0x57c507 = Math.floor(
              ((((_0x1e4ea9 - fuelAddAmount) * 100) / 30) * 4500) / 100
            )
            SetPedAmmo(_0x5c8eae, 883325847, _0x57c507)
          } else {
            const vehicleRefuelBill = await RPC.execute('arp-vehicles:chargeForFuelRefill', refuelPrice)
            if (!vehicleRefuelBill) {
              emit('DoLongHudText', 'Error charging for fuel refill', 1, 12000)
            }
          }
          if (fuelAddAmount > 0) {
            const refuelTargetVehicle = NetworkGetNetworkIdFromEntity(targetVeh)
            await RPC.execute('arp:vehicles:addFuel', refuelTargetVehicle, fuelAddAmount, 1, canRefuel, refueling, _0x3f173a)
            SetVehicleFuelLevel(targetVeh, curVehicleFuel + fuelAddAmount)
          }
        }
        GetRefuelingData.RefuelVehicle = _0x36d9c7
        function GetJerryCanFuelAmount() {
          return ((((GetAmmoInPedWeapon(PlayerPedId(), 883325847) * 100) / 4500) * 35) / 100)
        }
        GetRefuelingData.GetJerryCanFuelLevel = GetJerryCanFuelAmount
        async function _0x1d77cf(_0x31b608) {
          const _0x42ae0e = PlayerPedId(),
            ...
            taskTimer = _0x154698 * 800
          await (0, _0x5eeb81.TurnPedEntity)(_0x42ae0e, _0x31b608)
          const startRefuelingJerryCan = new playerPlayJerryCanAnim.AnimationTask(PlayerPedId(), 'normal', 'Refilling Jerry Can', taskTimer, 'weapon@w_sp_jerrycan','fire'),
            _0x3e974e = await startRefuelingJerryCan.start(),
            _0x458939 = (_0x3e974e * _0x154698) / 100
          if (_0x458939 > 0) {
            await RPC.execute('arp:vehicles:refillJerryCan', _0x458939)
          }
        }
        GetRefuelingData.RefuelJerryCan = _0x1d77cf
      ...
      396: (_0x23cfb7, _0x1fe11f, _0x16e995) => {
        ...
        function _0x74be1e(_0x32c621) {
          if (!DoesEntityExist(_0x32c621) || !IsEntityAVehicle(_0x32c621)) {
            return
          }
          if (!_0x207cc4.has(_0x32c621)) {
            const _0x535026 = {
              _0x4a6ea6: GetVehicleHandlingFloat(
                _0x32c621,
                'CHandlingData',
                _0x4a6ea6
              ),
            }
            for (const _0x4a6ea6 of _0x59bb5f) {
            }
        ...
        function _0x1b7b4a(_0x22fcda) {
          const _0x360393 = (0, _0x25168f.GetVehicleMetadata)(
            _0x22fcda,
            'handling'
          )
          if (!_0x360393) {
        ...
        function _0x359127(_0x5682f7, _0xd7d16d) {
          const _0x54a64c =
            _0x2581da.DriverThread.isActive &&
            _0x2581da.DriverThread.data.vehicle === _0x5682f7,
            _0x3e2482 = _0x54a64c
              ? _0x2581da.DriverThread.data.handling
              : _0x1b7b4a(_0x5682f7)
          if (!_0x3e2482) {
        ...
        _0x16e995.g.exports(
          'MassSetHandlingContextMultipier',
          _0x1fe11f.MassSetHandlingContextMultipier
        )
        _0x16e995.g.exports(
          'MassResetHandlingContextMultipier',
          _0x1fe11f.MassResetHandlingContextMultipier
        )
      },
      369: (_0x431693, _0x481061, _0x533669) => {
        ...
        function _0x32fe02(_0x3bab07) {
          const _0x33663e = (0, _0x528d29.GetVehicleMetadata)(
            _0x3bab07,
            'harness'
          )
        ...
        function _0x8c7107(_0x12029a) {
          const _0x11a610 = (0, _0x528d29.GetVehicleMetadata)(
            _0x12029a,
            'harness'
          )
        ...
        function _0x472c1c(_0x582c18) {
          const _0x1d1b86 = NetworkGetNetworkIdFromEntity(
            _0x528d29.CurrentVehicle
          )
          if (!_0x1d1b86) {
            return
          }
          emitNet('arp:vehicles:DoHarnessDamage', _0x1d1b86, _0x582c18)
        }
        ...
        function _0x32d5bb(_0x1a1085) {
          if (
            _0x1a1085 &&
            (!_0x528d29.InVehicle || !_0x32fe02(_0x528d29.CurrentVehicle))
          ) {
            return
          }
        ...
        RegisterCommand('+toggleSeatbelt', async () => {
            ...
            if (!_0x481061.HasHarnessOn && _0x3c2176 && _0x93dbb7) {
              const finished = await (0, _0x5084fc.taskBar)(5000, 'Putting on Harness')
              if (finished !== 100) {
                return
              }
              _0x32d5bb(true)
              ...
              if (_0x481061.HasHarnessOn) {
                const _0x57926c = await (0, _0x5084fc.taskBar)(
                  1000,
                  'Taking off Harness'
                )
                if (_0x57926c !== 100) {
        ...
        _0x533669.g.exports['arp-binds'].registerKeyMapping(
          '',
          'Vehicle',
          'Seatbelt Toggle',
          '+toggleSeatbelt',
      ...
      965: (_0x4a069c, _0x22ddce, _0xde28c8) => {
        ...
        async function _0x394dcb(
          ...
          _0x460163 = true
          emit(
            'np-vehicle:client:doorLockpicking',
            NetworkGetNetworkIdFromEntity(_0x42f15c)
          )
          const _0x24b733 = await _0xde28c8.g.exports[
            'arp-interface'
          ...
          const _0x47bc80 = await _0xde28c8.g.exports[
            'arp-interface'
          ].taskBarSkill(2200, 4)
          if (_0x47bc80 !== 100) {
            _0x460163 = false
          ...
          if (_0x24b733 === 100 && _0x47bc80 === 100) {
            const _0x901dc6 = GetPedInVehicleSeat(_0x42f15c, -1)
            if (_0x901dc6 !== 0 && IsEntityDead(_0x901dc6)) {
              SetVehicleDoorsLocked(_0x42f15c, 0)
              setTimeout(() => SetControlNormal(0, 23, 2), 500)
              const _0x56c3e4 = await _0xde28c8.g.exports[
                'arp-taskbar'
              ].taskBar(5000, 'Taking car keys', false)
              emit('civilian:alertPolice', 20, 'lockpick', _0x42f15c)
              if (!_0x2b5956) {
                _0xde28c8.g.exports['arp-flags'].SetVehicleFlag(
                  _0x42f15c,
                  'isStolenVehicle',
                  true
                )
              ...
              if (_0x56c3e4 === 100) {
                emit('vehicle:keys:addNew', _0x42f15c)
                emit('DoLongHudText', 'Got the vehicle keys.', 1)
              }
            }
            SetVehicleDoorsLocked(_0x42f15c, 1)
        ...
        _0xde28c8.g.exports(
          'LockpickVehicleDoor',
          (_0x20f234, _0x59e81a = 'lockpick', _0x456a2c = false, _0x5b54d8) => {
            return _0x394dcb(_0x20f234, _0x59e81a, _0x456a2c, _0x5b54d8)
          }
        )
        async function _0x404ad3(_0x4217ea, _0x2cd61e, _0x46e57d, _0xa837df) {
          const _0x161f35 = await _0xde28c8.g.exports[
            'arp-interface'
          ].taskBarSkill(
          ...
          await _0xde28c8.g.exports['arp-taskbar'].taskBar(
            5000,
            'Hotwiring Stage 1 Complete'
          )
          const _0x44d803 = await _0xde28c8.g.exports[
            'arp-interface'
          ].taskBarSkill(
            Math.floor(Math.random() * 5000) + 5000,
            Math.floor(Math.random() * 5) + 10
          ...
          const _0x1b2369 = await _0xde28c8.g.exports[
            'arp-interface'
          ...
          if (_0x161f35 === 100 && _0x44d803 === 100 && _0x1b2369 === 100) {
            ...
            if (
              ...
              await _0xde28c8.g.exports['arp-flags'].SetVehicleFlag(
                _0x4217ea,
                'isStolenVehicle',
                true
              )
        ...
        RegisterCommand(
          ...
          () => {
            const _0x1a97c9 =
              _0xde28c8.g.exports['arp-targetinteract'].GetCurrentEntity()
            let _0x127af6
        ...
        _0xde28c8.g.exports['arp-binds'].registerKeyMapping(
          '',
          'Vehicle',
          'Lock Doors',
          '+vehicleLock',
      ...
      141: (_0x75b0e2, _0x4eae01, _0x5a8267) => {
        ...
        function _0x488a31(_0x791e1b) {
          const _0x27d176 = (0, _0x117769.GetVehicleMetadata)(
            _0x791e1b,
            'mileage'
          )
        ...
        function _0x182ddd(_0x4c3da6, _0xaaab3) {
          ...
          ; (0, _0x92b600.DoRandomDegradation)(
            _0x4c3da6,
            (_0x3a2a0f / 10) * 2,
            true
          )
          TriggerServerEvent(
            'arp:vehicles:addMileage',
            NetworkGetNetworkIdFromEntity(_0x4c3da6),
            _0x3a2a0f
          )
        }
      ...
      547: (_0x4519e6, Function, _0x292651) => {
        Object.defineProperty(Function, '__esModule', { value: true })
        Function.RefillNOSCan =
          Function.IsUsingNitro =
          Function.GetNitroLevel =
          Function.VehicleHasNitro =
          Function.InitNosRefil =
          void 0
        const _0x598f6c = _0x292651(615),
          _0x3210c4 = _0x292651(570),
          Object = _0x292651(450),
          employmentCache = CacheableMap(
            async (_0x577cf9, _0x26abac) => {
              const _0x2d988e =
                exports['arp-business'].IsEmployedAt(_0x26abac)
              return [true, _0x2d988e]
            },
            { timeToLive: 60000 }
          ),
          _0x4a642d = CacheableMap(
            async (_0x27b4b2, _0x3a60b4, _0x495ba6, _0x1e1878) => {
              const _0xdfad91 = exports[
                'arp-business'
              ].HasPermission(_0x495ba6, _0x1e1878)
              return [true, _0xdfad91]
            },
            { timeToLive: 60000 }
          )
          async function InitNosRefill() {
            exports["np-polytarget"].AddBoxZone("nitro_refill", { x: 137.51, y: -3051.41, z: 7.04 }, 0.8, 0.6, { heading: 30, minZ: 5.84, maxZ: 7.44, data: { id: 'tuner_refill', business: 'tuner' } });
            exports["np-polytarget"].AddBoxZone("nitro_refill", { x: 1185.08, y: 2636.82, z: 37.76 }, 0.6, 0.6, { heading: 4, minZ: 36.76, maxZ: 38.16, data: { id: 'harmony_refill', business: 'harmony_repairs' } });
            exports["np-interact"].AddPeekEntryByPolyTarget("nitro_refill", [{ id: 'np-vehicles:client:refillNoS', event: 'np-vehicles:client:refillNoS', icon: 'fill', label: 'Refill Nitro (2 GNE)' }], {
                distance: { radius: 3.5 },
                isEnabled: (pEntity, pContext) => {
                    var p1, p2;
        ...
        Function.InitNosRefil = InitNosRefill
        function VehicleHasNitro(pVehicle) {
          const nitro = (0, Object.GetVehicleMetadata)(pVehicle, 'nitro')
          return nitro ? nitro > 0 : false
        }
        Function.VehicleHasNitro = VehicleHasNitro
        function GetNitroLevel(_0x26c41a) {
          const _0x423f19 = (0, Object.GetVehicleMetadata)(_0x26c41a, 'nitro')
          return typeof _0x423f19 === 'number' ? _0x423f19 : 0
        }
        Function.GetNitroLevel = GetNitroLevel
        function isUsingNitro() {
          return _0x3210c4.NitroThread.isActive
        }
        Function.IsUsingNitro = isUsingNitro
        async function _0x20ea75(_0x2357ae) {
          let _0x3c7271 = ''
          if (!_0x2357ae) {
            return false
          }
          const hasEnough = exports['arp-inventory'].hasEnoughOfItem('nitrous', 1)
          if (!hasEnough) {
            return false
          }
          const pItemInfo = exports['arp-inventory'].GetInfoForFirstItemOfName('nitrous')
          if (!pItemInfo) {
            return false
          }
          const pStatus = (_0x3c7271 = JSON.parse(pItemInfo.information).Status) !== null && _0x3c7271 !== void 0 ? _0x3c7271 : 'Filled'
          if (pStatus === 'Filled') { return emit('DoLongHudText', 'Nitrous can is already full.')}
          const pQuantity = item.quantity, pCost = pQuantity * 2, finished = await exports['arp-phone'].DoPhoneConfirmation(30, 'Nitrous Refill (' + pQuantity + ')', 'Will cost ' + pCost + ' GNE', 'file-invoice-dollar')
          if (!finished) { return false }
          emit('animation:PlayAnimation', 'type')
          const progress = await (0, _0x598f6c.taskBar)(5000, 'Refill NOS Can')
          ClearPedTasks(PlayerPedId())
          if (progress !== 100) {
            return false
          }
          return (emit( 'inventory:updateItem', 'nitrous', pItemInfo.slot, JSON.stringify({ Status: 'Filled' })),
            emit('DoLongHudText', 'Successfully refilled nitrous can.'), true)
        }
        Function.RefillNOSCan = _0x20ea75
        exports('GetNitroLevel', GetNitroLevel)
        exports('IsUsingNitro', isUsingNitro)
        exports('VehicleHasNitro', VehicleHasNitro)
        exports('RefillNOSCan', _0x20ea75)
      },
      348: (_0x3389c5, _0x4a3d36, _0x58ebe5) => {
        ...
        _0x4a3d36.DriverThread.addHook('preStart', function () {
          ...
          this.data.netId = NetworkGetNetworkIdFromEntity(
            _0x3032be.CurrentVehicle
          )
      ...
      570: (_0xacdd13, _0x1dbe26, _0x30b1e9) => {
        ...
        NitroThread.addHook('active', function () {
          ...
          if (
            ...
            _0x2ad070 > nitroConfig.highBurstSpeed
          ) {
            const _0x4af470 =
              _0x2ad070 >= nitroConfig.lowBurstSpeed
                ? nitroConfig.lowBurst
                : nitroConfig.highBurst,
              _0x12e656 = 1 + (_0x4af470 * (nitroConfig.flowRate * 10)) / 100
            this.data.multiplier !== _0x12e656 &&
              ((this.data.multiplier = _0x12e656),
                (0, Object.SetHandlingContextMultiplier)(
                  this.data.vehicle,
                  'fInitialDriveForce',
                  'nitro',
                  'multiplier',
                ...
                (0, Object.ApplyHandlingMultipliers)(
                  this.data.vehicle,
                  'fInitialDriveForce'
                ))
          ...
          if (
            _0x2ad070 > nitroConfig.blowoutSpeed &&
            _0x15975a > nitroConfig.blowoutTickThreshold
          ) {
            const _0x56c469 = (0, _0x450f48.GetRandom)(100),
              _0x327c96 = this.data.vehicle,
              _0x311d47 = GetVehicleEngineHealth(_0x327c96)
            if (_0x311d47 <= 0 || _0x56c469 <= nitroConfig.blowoutPercentage) {
          ...
          this.delay = 1500 - nitroConfig.flowRate * 100
        })
        NitroThread.DriverThread.addHook('afterStart', async function () {
          NitroThread.data.driver = this.data
          NitroThread.data.vehicle = _0x3b302f.CurrentVehicle
          NitroThread.data.netId = NetworkGetNetworkIdFromEntity(
            this.data.vehicle
          )
          NitroThread.data.exhausts = (0,
            _0x450f48.GetVehicleExhausts)(this.data.vehicle)
        })
        NitroThread.DriverThread.addHook('afterStop', async function () {
        ...
        NitroThread.addHook('preStart', function () {
          ...
          this.data.mode = nitroConfig.mode
          ...
          if (this.data.mode === 'Purge') {
            emitNet('fx:purgeL', this.data.particleId, this.data.netId, nitroConfig.flowRate)
            emitNet('fx:purgeR', this.data.particleId, this.data.netId, nitroConfig.flowRate)
            ...
            this.data.mode === 'Boost' &&
              ...
              emit('fx:nitrous', this.data.vehicle, this.data.exhausts, GetEntityPitch(_0x3b302f.CurrentVehicle), nitroConfig.flowRate))
          }
          emit('noshud', this.data.nitroLevel, true)
        ...
        NitroThread.addHook('preStop', function () {
          ...
          const oldNitrous = (0, _0x439326.GetNitroLevel)(this.data.vehicle),
                newNitrous = oldNitrous - this.data.nitroLevel;
          SetVehicleBoostActive(this.data.vehicle, false)
            (0, Object.ResetHandlingContextMultipier)(this.data.vehicle, 'fInitialDriveForce', 'nitro')
            (0, Object.ApplyHandlingMultipliers)(this.data.vehicle, 'fInitialDriveForce')
          ...
          emitNet('arp:vehicles:nitroUsed', this.data.netId, newNitrous)
        })
        function useNitroOn() {
          if (!_0x3b302f.CurrentVehicle || _0x3b302f.CurrentSeat !== -1 || (0, _0x450f48.IsThrottled)('nitro')) {
            return
          }
          NitroThread.start()
        }
        function useNitroOff() {
          if (!NitroThread.isActive) {
            return
          }
          NitroThread.stop()
        ...
        function toggleNitroMode() {
          ...
          nitroConfig.mode = nitroConfig.mode === 'Boost' ? 'Purge' : 'Boost'
          emit('DoLongHudText', 'Nitro mode: ' + nitroConfig.mode, 1)
        }
        function increaseNitroFlow() {
          ...
          nitroConfig.flowRate + 1 <= 10 ? nitroConfig.flowRate++ : 10
          emit('DoLongHudText', 'Nitrous flow rate: ' + nitroConfig.flowRate, 1, 12000)
        }
        ...
        function decreaseNitroFlow() {
          ...
          nitroConfig.flowRate - 1 >= 1 ? nitroConfig.flowRate-- : 1
          emit('DoLongHudText', 'Nitrous flow rate: ' + nitroConfig.flowRate, 1, 12000)
        }
        ...
        exports['arp-binds'].registerKeyMapping('', 'Vehicle', 'Toggle Nos / Purge Mode', '+toggleNitroMode', '-toggleNitroMode')
        exports['arp-binds'].registerKeyMapping('', 'Vehicle', 'Nos Flow Increase', '+increaseNitroFlow', '-increaseNitroFlow')
        exports['arp-binds'].registerKeyMapping('', 'Vehicle', 'Nos Flow Decrease', '+decreaseNitroFlow', '-decreaseNitroFlow')
        exports['arp-binds'].registerKeyMapping('', 'Vehicle', 'Activate Nos', '+useNitro', '-useNitro', 'LSHIFT')
      },
      ...
      413: (_0x507936, _0x5e9d5d, _0x19469a) => {
        ...
        RegisterInterfaceCallback(
          'arp-interface:applicationClosed',
          (_0x273d64, _0x21559b) => {
            _0x273d64.name === 'contextmenu' &&
              _0x41310d &&
              ((_0x41310d = false),
        ...
        RegisterInterfaceCallback(
          'arp:vehicles:vehiclePreview',
          (_0x4137bf, _0x3ec933) => {
            const _0xfb56b3 = _0x4137bf.key
            _0xfb56b3.state === 'stored' &&
              (0, _0x2173f4.PreviewCar)(
                _0xfb56b3.vin,
                _0xfb56b3.garage,
                _0xfb56b3?.data
              )
        ...
        RegisterInterfaceCallback(
          'arp:vehicles:spawnVehicle',
          async (_0xb4f7bf, _0x272915) => {
            const _0x5dbf1a = _0xb4f7bf.key
            _0x5dbf1a.state === 'stored' && _0x2173f4.currentParkingSpot
              ? (0, _0x2173f4.SpawnGarageVehicle)(
                _0x5dbf1a.vin,
                _0x5dbf1a.garage,
                _0x5dbf1a?.raid
              )
        ...
        RegisterInterfaceCallback(
          ...
          async (_0x5680a6, _0x2d3dfb) => {
            ...
            if (_0xc67db4) {
              const _0x3202dd = _0x19469a.g.exports.isPed.isPed('mycash')
        ...
        RegisterInterfaceCallback(
          'arp-vehicles:fetchParkingLogs',
          async (_0x199763, _0x4b95de) => {
            _0x4b95de({
              data: {},
              meta: {
                ok: true,
            ...
            const _0x23badb = _0x199763.key
            DoesEntityExist(_0x2173f4.previewCar) &&
              ((0, _0x2173f4.ResetParkingSpot)(),
                DeleteEntity(_0x2173f4.previewCar))
            const _0x5d28a7 = await RPC.execute(
              'arp:vehicles:fetchParkingLogs',
              _0x23badb.vin,
              _0x23badb.garage
            ),
            ...
            _0x19469a.g.exports['arp-interface'].showContextMenu(_0x398ebf)
          }
        )
        ...
        function getVehiclesInGarage(
          ...
          const _0x505340 = []
          return _0x3b433e.reduce((_0x47471d, garageVehicle) => {
            const _0x20a838 = {
              title:
                '' +
                (garageVehicle.name
                  ? garageVehicle.name
                  : GetLabelText(
                    GetDisplayNameFromVehicleModel(garageVehicle.model)
                  )),
              description:
                'Plate: ' +
                garageVehicle.plate +
                ' | ' +
                (0, _0x480a0b.Capitalize)(garageVehicle.state),
              key: {
                state: garageVehicle.state,
                garage: garageVehicle.garage,
                vin: garageVehicle.vin,
              },
              extraAction: 'arp:vehicles:vehiclePreview',
              children: [
                {
                  title: 'Take Out Vehicle',
                  description: '',
                  action: 'arp:vehicles:spawnVehicle',
                  disabled: _0x44f00d
                    ? garageVehicle.state !== 'stored' &&
                    garageVehicle.state !== 'locked'
                    : garageVehicle.state !== 'stored',
                  key: {
                    state: garageVehicle.state,
                    garage: garageVehicle.garage,
                ...
                },
                {
                  ...
                  description:
                    ...
                    ' | ' +
                    _0x1d4924(
                      garageVehicle.damage ? JSON.parse(garageVehicle.damage || []) : []
                    ),
                },
              ],
            }
            return (_0x4ca168 && (_0x20a838.children.push({
                title: 'Set as Display Vehicle',
                description: '',
                action: 'arp-vehicles:setDisplayVehicle',
                disabled: garageVehicle.state !== 'stored',
                key: {
                  vin: garageVehicle.vin,
                  garage: garageVehicle.garage,
                  state: garageVehicle.state,
                ...
                _0x20a838.children.push({
                  ...
                  description: '',
                  action: 'arp-vehicles:setDisplayVehicle',
                  disabled: garageVehicle.state !== 'showcase',
                  key: {
                    vin: garageVehicle.vin,
                    garage: garageVehicle.garage,
                    state: garageVehicle.state,
              ...
              _0x20a838.children.push({
                ...
                description: '',
                action: 'arp-vehicles:toggleVehicleLockdown',
                disabled:  garageVehicle.state !== 'stored' && garageVehicle.state !== 'locked',
                  key: {
                    vin: garageVehicle.vin,
                    garage: garageVehicle.garage,
                    state: garageVehicle.state,
              ...
              _0x505340 &&
              _0x505340[garageVehicle.model] &&
              ['pd_shared', 'pd_shared_bike'].includes(garageVehicle.garage) &&
              _0x20a838.children.push({
                title: 'Retrieve Vehicle',
                description: '',
                action: 'arp-vehicles:retrieveVehicle',
                disabled: garageVehicle.state === 'stored',
                key: {
                  vin: garageVehicle.vin,
                  garage: garageVehicle.garage,
              ...
              _0x20a838.children.push({
                ...
                description: '',
                action: 'arp-vehicles:fetchParkingLogs',
                key: {
                  vin: garageVehicle.vin,
                  garage: garageVehicle.garage,
                  state: garageVehicle.state,
        ...
        function _0x193efc(
          ...
          return Object.values(_0x2b1949).reduce((_0x568e8b, sharedVehicleModel) => {
            const _0x3a6938 = getVehiclesInGarage(
              sharedVehicleModel.sort((sharedVehicleName, sharedVehicleData) =>
                sharedVehicleName.name.localeCompare(
                  sharedVehicleData.name ? sharedVehicleData.name : sharedVehicleData.model
                )
              ),
              _0x4f852d,
              _0x133f7d,
            ...
            policeDepartments = ['LSPD', 'BCSO', 'SASPR', 'SASP', 'UM']
            ...
            return (
              _0x568e8b.push({
                title:
                  '' +
                  (sharedVehicleTypes[sharedVehicleModel[0].model] || sharedVehicleModel[0].name
                    ? sharedVehicleModel[0].name
                    : sharedVehicleModel[0].model),
                description:
                  sharedVehicleModel.length +
                  ' ' +
                  (sharedVehicleModel.length === 1 ? 'Vehicle' : 'Vehicles'),
                children: _0x3a6938,
              }),
              _0x568e8b
            )
        ...
        function _0x5afae1(
          ...
          return _0x206f4a.reduce((_0x5906cc, _0x5dfffe) => {
            const _0x513a93 = getVehiclesInGarage(_0x3cd9e4, _0x5dfffe, _0x596e92, _0x3b59dc, _0x6def53)
            return (
              _0x513a93 &&
              _0x5906cc.push({
                title:
                  'Vehicle List (' +
                  (0, _0x480a0b.Capitalize)(_0x5dfffe) +
                  ')',
        ...
        async function _0x58c2e8(_0x3f6151) {
          ...
          _0x41310d = true
          _0x19469a.g.exports['arp-interface'].showContextMenu(
            [..._0x2cbd42],
            'right'
          )
        }
      ...
      450: (_0xcf1860, _0x8810cd, _0x3c7fc0) => {
        ...
        async function _0x50c23a(_0x386f34) {
          ...
          const _0x68347d = NetworkGetNetworkIdFromEntity(_0x386f34),
            ...
            _0x2e6e2e = await RPC.execute(
              'arp:vehicles:generateVehicleInformation',
              _0x68347d,
              _0x458e84
            )
          return _0x2e6e2e
        ...
        _0x3c7fc0.g.exports['arp-binds'].registerKeyMapping(
          '',
          'Vehicle',
          'Engine On',
          '+engineOn',
      ...
      895: (_0x4fa86f, _0x5aa20a, configExport) => {
        ...
        _0x5aa20a.IsConfigReady =
          ...
          void 0
        let _0x1b0e39 =
          configExport.g.exports['arp-config'].GetModuleConfig('main')
        const _0x5aa110 = new Map(),
          reourceName = GetCurrentResourceName()
        async function _0x515f8c() { }
        _0x5aa20a.InitConfig = _0x515f8c
        on('arp-config:configLoaded', (_0x31742c, _0x188cc1) => {
          if (_0x31742c === 'main') {
            _0x1b0e39 = _0x188cc1
          } else {
        ...
        function _0x5c1576(_0x4c27c6, _0x52a0a9) {
          if (!_0x5aa110.has(_0x4c27c6)) {
            const _0xfc67b0 =
              configExport.g.exports['arp-config'].GetModuleConfig(_0x4c27c6)
        ...
        const _0x321f21 = () => {
          return new Promise((_0x2a4051) => {
            ...
            const _0x18f6bd = setInterval(() => {
              if (configExport.g.exports['arp-config'].IsConfigReady()) {
      ...
      849: (_0x18f78e, polyProperty, polyzoneAdded) => {
        Object.defineProperty(polyProperty, '__esModule', { value: true })
        polyProperty.PolyZone = void 0
        class _0xfeed24 {
          static ['addBoxZone'](
            _0x3ffe1f,
            _0x10bb27,
            ...
            return polyzoneAdded.g.exports['arp-polyzone'].AddBoxZone(
              _0x3ffe1f,
              _0x10bb27,
              _0x187eab,
              _0x215e89,
          ...
          static ['addCircleZone'](polyName, polyCoords, polyMinZ, polyMaxZ) {
            return polyzoneAdded.g.exports['arp-polyzone'].AddCircleZone(
              polyName,
              polyCoords,
              polyMinZ,
              polyMaxZ
        ...
        polyProperty.PolyZone = _0xfeed24
      },
      615: (_0x49ffb2, selectedVehicle, vehiclesExport) => {
        Object.defineProperty(selectedVehicle, '__esModule', { value: true })
        selectedVehicle.OpenInputMenu =
          selectedVehicle.IsThrottled =
          selectedVehicle.Throttle =
          selectedVehicle.GetVehicleExhausts =
          selectedVehicle.loadAndRequestModel =
          selectedVehicle.requestAnimDict =
          selectedVehicle.taskBarSkill =
          selectedVehicle.taskBar =
          selectedVehicle.Capitalize =
          selectedVehicle.GetRandom =
          selectedVehicle.loadAnimDict =
          selectedVehicle.Delay =
          selectedVehicle.GetPedVehicleSeat =
          selectedVehicle.SyncedExecution =
          selectedVehicle.PlayEntitySound =
          selectedVehicle.GetClosestPlayer =
          void 0
        ...
        selectedVehicle.GetClosestPlayer = _0x1cf96c
        async function vehicleSound(
          _0x4696a0,
          _0x207aa7,
          _0x7e60be,
          _0x23d3bb = 1000
          ...
          await (0, selectedVehicle.Delay)(_0x23d3bb)
          StopSound(_0x348c49)
          ReleaseSoundId(_0x348c49)
        }
        selectedVehicle.PlayEntitySound = vehicleSound
        function vehicleSyncedExecution() { }
        selectedVehicle.SyncedExecution = vehicleSyncedExecution
        function _0x1d10b8(_0x4752e4, curVehiclePedIsIn) {
          const vehSeatNumber = GetVehicleModelNumberOfSeats(
            GetEntityModel(curVehiclePedIsIn)
          )
          for (let _0x188f78 = -1; _0x188f78 < vehSeatNumber - 1; _0x188f78 += 1) {
            const _0xbfe1c2 = GetPedInVehicleSeat(curVehiclePedIsIn, _0x188f78)
            if (_0xbfe1c2 && _0xbfe1c2 === _0x4752e4) {
              return _0x188f78
            }
          }
        }
        selectedVehicle.GetPedVehicleSeat = _0x1d10b8
        const _0x2443a8 = (_0x5bcacb) =>
          new Promise((_0x54dc03) => setTimeout(_0x54dc03, _0x5bcacb))
        selectedVehicle.Delay = _0x2443a8
        async function _0x585d43(_0x63fe67) {
          while (!HasAnimDictLoaded(_0x63fe67)) {
            RequestAnimDict(_0x63fe67)
            await (0, selectedVehicle.Delay)(5)
          }
        }
        selectedVehicle.loadAnimDict = _0x585d43
        ...
        selectedVehicle.GetRandom = _0xcef5a5
        function _0x143a89(getVehicleName) {
          return getVehicleName.charAt(0).toUpperCase() + getVehicleName.slice(1)
        }
        selectedVehicle.Capitalize = _0x143a89
        function _0x1eea5b(taskTime, taskText, _0x10f704 = false) {
          return new Promise((_0x3f81c6) => {
            if (taskText) {
              vehiclesExport.g.exports['arp-taskbar'].taskBar(
                taskTime,
                taskText,
                _0x10f704,
                true,
              ...
              setTimeout(() => _0x3f81c6(100), taskTime)
            }
          })
        }
        selectedVehicle.taskBar = _0x1eea5b
        function _0x21d165(_0x2f7de5, _0x2960c0) {
          return new Promise((_0x2f6d58) => {
            vehiclesExport.g.exports['arp-ui'].taskBarSkill(
              _0x2f7de5,
              _0x2960c0,
              _0x2f6d58
            )
        ...
        selectedVehicle.taskBarSkill = _0x21d165
        async function _0x4453de(_0x1e540a) {
          if (!HasAnimDictLoaded(_0x1e540a)) {
            ...
            while (!HasAnimDictLoaded(_0x1e540a) && !_0x4504d9) {
              await (0, selectedVehicle.Delay)(10)
            }
          }
        }
        selectedVehicle.requestAnimDict = _0x4453de
        async function _0x25614b(_0x346cc4) {
          const vehicleModel =
            typeof _0x346cc4 === 'number' ? _0x346cc4 : GetHashKey(_0x346cc4)
          if (!HasModelLoaded(vehicleModel) && IsModelInCdimage(vehicleModel)) {
            RequestModel(vehicleModel)
            let _0x1223b1 = false
            setTimeout(() => (_0x1223b1 = true), 60000)
            while (!HasModelLoaded(vehicleModel) && !_0x1223b1) {
              await (0, selectedVehicle.Delay)(10)
            }
          }
        }
        selectedVehicle.loadAndRequestModel = _0x25614b
        ...
        selectedVehicle.GetVehicleExhausts = _0x14751e
        ...
        selectedVehicle.Throttle = _0x5b9faa
        function _0xad3bbd(_0x1c0557) {
          return _0x42fa4a.has(_0x1c0557)
        }
        selectedVehicle.IsThrottled = _0xad3bbd
        let _0x5cf44d = 0
        ...
        RegisterInterfaceCallback(
          ...
          (_0x1cf791, _0x177777) => {
            if (
              _0x1cf791.name !== 'textbox' ||
              _0x1cf791.callbackUrl !== 'arp-interface:menu:input'
            ) {
              return
            }
            const _0x3a6ae5 = _0x3d2d31.get(_0x1cf791.key)
            if (!_0x3a6ae5) {
              return
            }
            _0x3a6ae5.resolve(null)
            _0x3d2d31.delete(_0x1cf791.key)
          }
        )
        RegisterInterfaceCallback(
          'arp-interface:menu:input',
          (_0x594f91, _0x5b28ac) => {
            _0x5b28ac({
              data: {},
              meta: {
            ...
            const _0xa2e328 = _0x3d2d31.get(_0x594f91.key)
            if (!_0xa2e328) {
              return
            }
            const _0x445edf = _0xa2e328.validation
              ? _0xa2e328.validation(_0x594f91.values)
              : true
            if (!_0x445edf) {
              return
            }
            _0xa2e328.resolve(_0x594f91.values)
            _0x3d2d31.delete(_0x594f91.key)
            vehiclesExport.g.exports['arp-interface'].closeApplication('textbox')
          }
        )
        function _0x381b8f(_0x4f27c3, _0x333b23) {
          ...
          return (
            vehiclesExport.g.exports['arp-interface'].openApplication('textbox', {
              callbackUrl: 'arp-interface:menu:input',
              key: _0x5af49f,
              items: _0x4f27c3,
              show: true,
            }),
        ...
        selectedVehicle.OpenInputMenu = _0x381b8f
      },
      433: (_0x9b9f15, Ped, _0x3ee237) => {
        Object.defineProperty(Ped, '__esModule', { value: true })
        Ped.GetDistanceFromEngine =
          Ped.unkFunc41 =
          Ped.GetDistance =
          Ped.TurnPedEntity =
          Ped.TurnPedCoords =
        ...
        function GetClosestBone(_0x11df56, _0x104991) {
          let _0x5de606 = 0,
            _0xf03452 = '',
            _0x4d29d1 = 0,
            _0x1398bf
          ...
          return (
            _0x104991.forEach((_0x4fdaed) => {
              ...
              const _0x31a4b9 = GetWorldPositionOfEntityBone(
                ...
                _0x2cfe64 = GetDistance(_0x3fb7b4, _0x31a4b9, false)
        ...
        Ped.GetClosestBone = GetClosestBone
        async function TurnPedCoords(_0x197e81, [_0x30b13a, _0xb63b18, _0x401fc5]) {
        ...
        Ped.TurnPedCoords = TurnPedCoords
        async function TurnPedEntity(_0x456391, _0x1ce746) {
        ...
        Ped.TurnPedEntity = TurnPedEntity
        function GetDistance([pCoord1X, pCoord1Y, pCoord1Z], [pCoord2X, pCoord2Y, pCoord2Z], pUseZ = false) {
          return GetDistanceBetweenCoords(pCoord1X, pCoord1Y,  pCoord1Z, pCoord2X, pCoord2Y, pCoord2Z, pUseZ)
        }
        Ped.GetDistance = GetDistance

        function unkFunc40(pEntity, pType, pBoneId) {
          let pBoneIndex
          if (pType === 1 && typeof pBoneId === 'number') {
            pBoneIndex = GetPedBoneIndex(pEntity, pBoneId)
          } else {
            pType === 2 &&
              typeof pBoneId === 'string' &&
              (pBoneIndex = GetEntityBoneIndexByName(pEntity, pBoneId))
          }
          return GetWorldPositionOfEntityBone(pEntity, pBoneIndex)
        }

        function unkFunc41(pEntity, pType, pBoneId, pCoords) {
        ...
        Ped.unkFunc41 = unkFunc41

        function unkFunc42(pEntity) {
        ...
        Ped.GetDistanceFromEngine = unkFunc44
      },
      281: (_0x4b44d4, _0x2bd86b) => {
        ...
        class _0x365878 {
          ...
          ['has'](_0x4a57bd) { return this['_entries'].has(_0x4a57bd)}
          ['isExpired'](_0x1b13e7) { const { ttl: _0x56e291, timestamp: _0x52f03e } = this['_entries'].get(_0x1b13e7) 
          return Date.now() - _0x52f03e > _0x56e291}
          ['get'](_0x233a69) { return this['_entries'].get(_0x233a69).value}
          ['set'](_0x382581, _0x59c45b, _0x45f97c = 1000) { this['_entries'].set(_0x382581, { value: _0x59c45b, timestamp: Date.now(), ttl: _0x45f97c})}
          ['delete'](_0x53e814) { return this['_entries'].delete(_0x53e814) }
          ['clear']() { this['_entries'].clear() }
          ['forEach'](_0xcc09bf) { this['_entries'].forEach((_0x567ffc, _0x2533d5) => _0xcc09bf(_0x567ffc.value, _0x2533d5))}
          ['find'](_0x4fed31) { return [...this['_entries'].entries()].find((_0x378a71) => _0x4fed31(_0x378a71.value))}
          ['some'](_0x2d54aa) { return [...this['_entries'].entries()].some((_0x2f75a2) => _0x2d54aa(_0x2f75a2.value))}
        }
        _0x2bd86b.Cache = _0x365878
      },
      543: (_0x185428, vehicleData) => {
        Object.defineProperty(vehicleData, '__esModule', { value: true })
        vehicleData.Mods = void 0
        var Mods
          ; (function (Mods) {
          ...
          })((Mods = vehicleData.Mods || (vehicleData.Mods = {})))
      },
    },
