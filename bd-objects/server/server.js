! function() {
	onNet('arp-objects:requestObjects', async () => {
		let _0x5794d6 = source,
			_0x27455e = await SQL.execute('SELECT * FROM __objects', {}),
			_0x24d63d = [];
		...
		emitNet('arp-objects:loadObjects', _0x5794d6, _0x24d63d);
	}), onNet('arp-objects:prepareObject', async (_0x22d447, _0x281017, _0x495c93, _0x56a363, _0x210483, _0x2fc667) => {
		let _0x36c5c9 = {
				'x': _0x281017,
				'y': _0x495c93,
				'z': _0x56a363,
		...
		let _0x398ffa = await SQL.execute('SELECT * FROM __objects WHERE randomId = @randomId', {
			'randomId': _0x24aa46
		});
		...
		emitNet('arp:objects:prepareNewObject', -1, _0x590114);
	}), RPC.register('arp-objects:SaveObject', async (_0x2fcf9b, _0x201f43, _0xb11f82, _0x33f68d, _0x4159b7, _0x215819) => {
		let _0x5eecf6 = {
				'x': _0x33f68d.x,
				'y': _0x33f68d.y,
				'z': _0x33f68d.z,
		...
		let _0x4a1b16 = await SQL.execute('SELECT * FROM __objects WHERE randomId = @randomId', {
			'randomId': _0x3ba958
		});
		...
		return emitNet('arp:objects:prepareNewObject', -1, _0x1f8112), true;
	}), RPC.register('arp-objects:DeleteObject', async (_0x5c09c2, _0x51b12d) => {
		let _0x2fb105 = await SQL.execute('SELECT * FROM __objects WHERE id = @id', {
			'id': _0x51b12d
		});
		...
		return !!(await SQL.execute('DELETE FROM __objects WHERE id = @id', {
			'id': _0x51b12d
		})) && (emitNet('arp-objects:clearObjects', -1, _0x1225f7), true);
	}), RPC.register('arp-objects:UpdateObject', async (_0x22a869, _0xf79e9b, _0x43c89e) => {
		if (!(await SQL.execute('UPDATE __objects SET model = @model WHERE id = @id', {
				'model': _0x43c89e,
				'id': _0xf79e9b
			}))) return false;

		let _0x3d7bfe = await SQL.execute('SELECT * FROM __objects WHERE id = @id', {
			'id': _0xf79e9b
		});
		...
		return emitNet('arp-objects:updateObjects', -1, _0x31af33), true;
	});
}();